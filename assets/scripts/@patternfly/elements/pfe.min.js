var Ci=Object.defineProperty;var vc=Object.getOwnPropertyDescriptor;var bt=(i,e)=>()=>(i&&(e=i(i=0)),e);var Bi=(i,e)=>{for(var t in e)Ci(i,t,{get:e[t],enumerable:!0})};var r=(i,e,t,o)=>{for(var l=o>1?void 0:o?vc(e,t):e,s=i.length-1,p;s>=0;s--)(p=i[s])&&(l=(o?p(e,t,l):p(l))||l);return o&&l&&Ci(e,t,l),l};var al=(i,e,t)=>{if(!e.has(i))throw TypeError("Cannot "+t)};var a=(i,e,t)=>(al(i,e,"read from private field"),t?t.call(i):e.get(i)),n=(i,e,t)=>{if(e.has(i))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(i):e.set(i,t)},f=(i,e,t,o)=>(al(i,e,"write to private field"),o?o.call(i,t):e.set(i,t),t);var c=(i,e,t)=>(al(i,e,"access private method"),t);var v,wt=bt(()=>{"use strict";v=class{get prefix(){return`[${this.host.localName}${this.host.id?`#${this.host.id}`:""}]`}static debugLog(e=null){try{return e!==null&&(v.logDebug=!!e,localStorage.pfeLog=!!e),localStorage.pfeLog==="true"}catch{return v.logDebug}}static log(...e){v.debugLog()&&console.log(...e)}static warn(...e){console.warn(...e)}static error(...e){console.error([...e].join(" "))}log(...e){v.log(this.prefix,...e)}warn(...e){v.warn(this.prefix,...e)}error(...e){v.error(this.prefix,...e)}constructor(e){if(this.host=e,v.instances.get(e))return v.instances.get(e);e.addController(this),v.instances.set(e,this)}hostConnected(){this.log("connected")}};v.instances=new WeakMap});function wi(i){return document.head.querySelector(`meta[name="${i}"]`)?.content}function zi(i){return{fromAttribute(e){return typeof e!="string"?null:e.split(",").map(i)},toAttribute(e){return e.join(",")}}}var fg,Wi,kr,B,Si,St=bt(()=>{fg=Symbol();Wi=zi(i=>parseInt(i?.trim(),10)),kr=zi(i=>i.trim()),B=class extends Event{constructor(e,t){super(e,{bubbles:!0,composed:!0,...t})}},Si=document.body.hasAttribute("no-auto-reveal");window.PfeConfig=Object.assign(window.PfeConfig??{},{trackPerformance:window.PfeConfig?.trackPerformance??wi("pf-track-performance")==="true",autoReveal:window.PfeConfig?.autoReveal??(Si?!Si:wi("pf-auto-reveal")==="true"),get log(){return!!localStorage.pfeLog},set log(i){i?localStorage.setItem("pfeLog",`${!0}`):localStorage.removeItem("pfeLog")}})});import{css as Pc}from"lit";var Ic,Ai,Di=bt(()=>{"use strict";Ic=Pc`:host{position:relative;display:inline-block;line-height:0;height:fit-content!important;width:fit-content!important}#container{display:grid;grid-template:1fr/1fr;place-content:center}#container.content ::slotted(*){display:none}svg{fill:currentcolor}`,Ai=Ic});import{LitElement as Oc,html as Ac}from"lit";import{property as _l}from"lit/decorators/property.js";import{state as Dc}from"lit/decorators/state.js";var ji,xl,He,Ar,Lt,de,Dr,Ni,jr,Ui,yl,P,qi=bt(()=>{"use strict";wt();Di();ji=window.requestIdleCallback??window.requestAnimationFrame,xl=class extends ErrorEvent{constructor(t,o){super("error",{message:`Could not load icon at ${t}`});this.originalError=o}},yl=class extends Oc{constructor(){super(...arguments);n(this,Lt);n(this,Dr);n(this,jr);this.set=a(this,Lt,de).defaultIconSet;this.icon="";this.loading="lazy";n(this,He,!1);n(this,Ar,new v(this))}static addIconSet(t,o){if(typeof o!="function")v.warn(`[${this.name}.addIconSet(setName, getter)]: getter must be a function`);else{this.getters.set(t,o);for(let l of this.instances)l.load()}}connectedCallback(){super.connectedCallback(),a(this,Lt,de).instances.add(this)}willUpdate(t){t.has("icon")&&c(this,jr,Ui).call(this)}disconnectedCallback(){super.disconnectedCallback(),a(this,Lt,de).instances.delete(this)}render(){let t=this.content??"";return Ac`
      <div id="container" aria-hidden="true">${t}<span part="fallback" ?hidden=${!!t}>
          <slot></slot>
        </span>
      </div>
    `}async load(){let{set:t,icon:o}=this,l=a(this,Lt,de).getters.get(t)??a(this,Lt,de).getIconUrl,s="UNKNOWN ICON";if(t&&o)try{let p=l(t,o);p instanceof URL?s=p.pathname:s=p;let d=await import(s);this.content=d.default instanceof Node?d.default.cloneNode(!0):d.default,await this.updateComplete,this.dispatchEvent(new Event("load",{bubbles:!0}))}catch(p){let d=new xl(s,p);a(this,Ar).error(p.message),this.dispatchEvent(d)}}},P=yl;He=new WeakMap,Ar=new WeakMap,Lt=new WeakSet,de=function(){return this.constructor},Dr=new WeakSet,Ni=function(){a(this,Lt,de).io.observe(this),a(this,He)&&this.load()},jr=new WeakSet,Ui=function(){switch(this.loading){case"idle":return void ji(()=>this.load());case"lazy":return void c(this,Dr,Ni).call(this);case"eager":return void this.load()}},P.styles=[Ai],P.getIconUrl=(t,o)=>new URL(`./icons/${t}/${o}.js`,import.meta.url),P.onIntersect=t=>t.forEach(({isIntersecting:o,target:l})=>{let s=l;f(s,He,o),ji(()=>{a(s,He)&&s.load()})}),P.io=new IntersectionObserver(yl.onIntersect),P.getters=new Map,P.instances=new Set,r([_l()],P.prototype,"set",2),r([_l({reflect:!0})],P.prototype,"icon",2),r([_l()],P.prototype,"loading",2),r([Dc()],P.prototype,"content",2)});import{css as jc}from"lit";var Nc,Gi,Vi=bt(()=>{"use strict";Nc=jc`:host([size=sm]) #container{--_size:var(--pf-global--icon--FontSize--sm, 10px)}:host([size=md]) #container{--_size:var(--pf-global--icon--FontSize--md, 18px)}:host([size=lg]) #container{--_size:var(--pf-global--icon--FontSize--lg, 24px)}:host([size=xl]) #container{--_size:var(--pf-global--icon--FontSize--xl, 54px)}#container,svg{width:var(--pf-icon--size,var(--_size));height:var(--pf-icon--size,var(--_size));min-width:var(--pf-icon--size,var(--_size));min-height:var(--pf-icon--size,var(--_size))}`,Gi=Nc});var Cl={};Bi(Cl,{PfIcon:()=>Kt});import{customElement as Uc}from"lit/decorators/custom-element.js";import{property as qc}from"lit/decorators/property.js";var Kt,xt=bt(()=>{"use strict";qi();Vi();Kt=class extends P{constructor(){super(...arguments);this.size="sm"}};Kt.styles=[...P.styles,Gi],Kt.defaultIconSet="fas",r([qc({reflect:!0})],Kt.prototype,"size",2),Kt=r([Uc("pf-icon")],Kt)});function L(i,e,t){if(typeof t?.value!="function")throw new TypeError(`Only methods can be decorated with @bound. <${e??i.name}> is not a method!`);return{configurable:!0,get(){let o=t.value.bind(this);return Object.defineProperty(this,e,{value:o,configurable:!0,writable:!0}),o}}}var wo=bt(()=>{"use strict"});import{__classPrivateFieldGet as _,__classPrivateFieldSet as yt}from"tslib";import{autoUpdate as Yp,computePosition as Xp,offset as Kp,shift as Zp,flip as Qp,arrow as Jp}from"@floating-ui/dom";var Ft,Wo,je,Ne,Zr,Qr,Jr,Lo,$t,Rl,Fl,Bn,$l,Ue,Hl=bt(()=>{"use strict";Ue=class{get alignment(){return _(this,Qr,"f")??"center"}get anchor(){return _(this,Zr,"f")??""}get open(){return _(this,Wo,"f")}get placement(){return _(this,Lo,"f")??"top"}get styles(){return _(this,Jr,"f")??{}}constructor(e,t){var o,l;Ft.add(this),this.host=e,Wo.set(this,!1),je.set(this,!1),Ne.set(this,void 0),Zr.set(this,void 0),Qr.set(this,void 0),Jr.set(this,void 0),Lo.set(this,void 0),$t.set(this,void 0),e.addController(this),yt(this,$t,t,"f"),(o=_(this,$t,"f")).invoker??(o.invoker=e),(l=_(this,$t,"f")).shift??(l.shift=!0)}hostDisconnected(){_(this,Ne,"f")?.call(this)}async show({offset:e,placement:t,flip:o,fallbackPlacements:l}={}){let s=_(this,Ft,"a",Rl),p=_(this,Ft,"a",Fl);if(!(!s||!p)){if(!_(this,je,"f")){yt(this,je,!0,"f");let d=_(this,Ft,"m",$l).call(this,t,e,o,l);yt(this,Ne,_(this,Ne,"f")??Yp(s,p,()=>_(this,Ft,"m",$l).call(this,t,e,o,l)),"f"),await d,yt(this,je,!1,"f")}yt(this,Wo,!0,"f"),this.host.requestUpdate()}}async hide(){for(await this.host.updateComplete;_(this,je,"f")&&!this.open;)await new Promise(requestAnimationFrame);yt(this,Wo,!1,"f"),_(this,Ne,"f")?.call(this),this.host.requestUpdate(),await this.host.updateComplete}};Wo=new WeakMap,je=new WeakMap,Ne=new WeakMap,Zr=new WeakMap,Qr=new WeakMap,Jr=new WeakMap,Lo=new WeakMap,$t=new WeakMap,Ft=new WeakSet,Rl=function(){let{invoker:e}=_(this,$t,"f");return typeof e=="function"?e():e},Fl=function(){let{content:e}=_(this,$t,"f");return typeof e=="function"?e():e},Bn=function(){let{arrow:e}=_(this,$t,"f");return typeof e=="function"?e():e},$l=async function(e="top",t,o=!0,l){var s,p;let{padding:d,shift:h}=_(this,$t,"f"),S=_(this,Ft,"a",Rl),O=_(this,Ft,"a",Fl),Z=_(this,Ft,"a",Bn);if(!S||!O)return;let{x:io,y:ol,placement:rl,middlewareData:bc}=await Xp(S,O,{strategy:"absolute",placement:e,middleware:[Kp(t),h&&Zp({padding:d}),Z&&Jp({element:Z,padding:Z.offsetHeight/2}),o&&Qp({padding:d,fallbackPlacements:l})].filter(Boolean)});if(Z){let{x:Le,y:yi}=bc.arrow||{},hc={top:"bottom",right:"left",bottom:"top",left:"right"}[rl.split("-")[0]]||"";Object.assign(Z.style,{left:Le!=null?`${Le}px`:"",top:yi!=null&&!["top"].includes(rl)?`${yi}px`:"",right:"",bottom:"",[hc]:`-${Z.offsetHeight/2}px`})}yt(this,Lo,rl,"f"),s=this,p=this,[{set value(Le){yt(s,Zr,Le,"f")}}.value,{set value(Le){yt(p,Qr,Le,"f")}}.value]=_(this,Lo,"f").split("-")??[],yt(this,Jr,{"--_floating-content-translate":`${io}px ${ol}px`},"f"),this.host.requestUpdate()}});import{css as td}from"lit";var ed,kn,wn=bt(()=>{"use strict";ed=td`:host{--_timestamp-text-decoration:underline dashed 1px;--_timestamp-text-underline-offset:4px;display:inline}*{box-sizing:border-box}#container{display:inline-flex;position:relative;max-width:100%;--_floating-arrow-size:var(--pf-c-tooltip__arrow--Width, 0.5rem)}#invoker.block{display:block}#tooltip,#tooltip::after{position:absolute}#tooltip{--_timestamp-text-decoration:none;--_timestamp-text-underline-offset:initial;display:block;opacity:0;pointer-events:none;z-index:10000;transition:opacity .3s cubic-bezier(.54, 1.5, .38, 1.11) 0s;text-align:center;word-break:break-word;translate:var(--_floating-content-translate);max-width:calc(100vw - 10px);width:max-content;top:0;left:0;will-change:opacity;line-height:var(--pf-c-tooltip--line-height, 1.5);max-width:var(--pf-c-tooltip--MaxWidth,18.75rem);box-shadow:var(--pf-c-tooltip--BoxShadow,var(--pf-global--BoxShadow--md,0 .25rem .5rem 0 rgba(3,3,3,.12),0 0 .25rem 0 rgba(3,3,3,.06)));padding:var(--pf-c-tooltip__content--PaddingTop,var(--pf-global--spacer--sm,.5rem)) var(--pf-c-tooltip__content--PaddingRight,var(--pf-global--spacer--sm,.5rem)) var(--pf-c-tooltip__content--PaddingBottom,var(--pf-global--spacer--sm,.5rem)) var(--pf-c-tooltip__content--PaddingLeft,var(--pf-global--spacer--sm,.5rem));font-size:var(--pf-c-tooltip__content--FontSize,
    var(--pf-global--FontSize--sm, .875rem));color:var(--pf-c-tooltip__content--Color,var(--pf-global--Color--light-100,#fff));background-color:var(--pf-c-tooltip__content--BackgroundColor,var(--pf-global--BackgroundColor--dark-100,#151515))}#tooltip::after{display:block;content:'';rotate:45deg;width:var(--_floating-arrow-size);height:var(--_floating-arrow-size);will-change:left top right bottom;background-color:var(--pf-c-tooltip__content--BackgroundColor,var(--pf-global--BackgroundColor--dark-100,#151515))}.open #tooltip{opacity:1}.left #tooltip::after{right:calc(-.5 * var(--_floating-arrow-size))}.left.center #tooltip::after{top:calc(50% - .5 * var(--_floating-arrow-size))}.left.start #tooltip::after{top:var(--_floating-arrow-size)}.left.end #tooltip::after{bottom:var(--_floating-arrow-size)}.top #tooltip::after{top:calc(100% - .5 * var(--_floating-arrow-size))}.top.center #tooltip::after{right:calc(50% - .5 * var(--_floating-arrow-size))}.top.start #tooltip::after{left:var(--_floating-arrow-size)}.top.end #tooltip::after{right:var(--_floating-arrow-size)}.right #tooltip::after{right:calc(100% - .5 * var(--_floating-arrow-size))}.right.center #tooltip::after{top:calc(50% - .5 * var(--_floating-arrow-size))}.right.start #tooltip::after{top:var(--_floating-arrow-size)}.right.end #tooltip::after{bottom:var(--_floating-arrow-size)}.bottom #tooltip::after{bottom:calc(100% - .5 * var(--_floating-arrow-size))}.bottom.center #tooltip::after{right:calc(50% - .5 * var(--_floating-arrow-size))}.bottom.start #tooltip::after{left:var(--_floating-arrow-size)}.bottom.end #tooltip::after{right:var(--_floating-arrow-size)}`,kn=ed});var Ln={};Bi(Ln,{PfTooltip:()=>q});import{LitElement as od,html as rd}from"lit";import{customElement as ad}from"lit/decorators/custom-element.js";import{property as Mo}from"lit/decorators/property.js";import{styleMap as ld}from"lit/directives/style-map.js";import{classMap as Sn}from"lit/directives/class-map.js";var id,nd,Ht,be,ta,zn,To,nt,qe,Eo,Pl,ea,Wn,Ro,Il,q,oa=bt(()=>{"use strict";Hl();wo();St();wn();id=["focusin","tap","click","mouseenter"],nd=["focusout","blur","mouseleave"],q=class extends od{constructor(){super(...arguments);n(this,Ht);n(this,ta);n(this,Eo);n(this,ea);n(this,Ro);this.position="top";this.noFlip=!1;n(this,To,!1);n(this,nt,void 0);n(this,qe,new Ue(this,{content:()=>a(this,ta,zn),invoker:()=>a(this,nt)?a(this,nt):a(this,Ht,be)instanceof HTMLSlotElement&&a(this,Ht,be).assignedElements().length>0?a(this,Ht,be).assignedElements().at(0):a(this,Ht,be)}))}connectedCallback(){super.connectedCallback(),c(this,Eo,Pl).call(this),c(this,Ro,Il).call(this)}willUpdate(t){t.has("trigger")&&c(this,Ro,Il).call(this)}render(){let{alignment:t,anchor:o,open:l,styles:s}=a(this,qe),p=a(this,To);return rd`
      <div id="container"
           style="${ld(s)}"
           class="${Sn({open:l,[o]:!!o,[t]:!!t})}">
        <slot id="invoker"
              class="${Sn({block:p})}"
              @slotchange="${c(this,Eo,Pl)}"
              role="tooltip"
              aria-labelledby="tooltip"></slot>
        <slot id="tooltip"
              name="content"
              aria-hidden="${String(!l)}">${this.content}</slot>
      </div>
    `}async show(){await this.updateComplete;let t=this.position,o=t?.match(/top|bottom/)?{mainAxis:15,alignmentAxis:-4}:15;await a(this,qe).show({offset:o,placement:t,flip:!this.noFlip,fallbackPlacements:this.flipBehavior})}async hide(){await a(this,qe).hide()}};Ht=new WeakSet,be=function(){return this.shadowRoot?.querySelector("#invoker")??null},ta=new WeakSet,zn=function(){return this.shadowRoot?.querySelector("#tooltip")??null},To=new WeakMap,nt=new WeakMap,qe=new WeakMap,Eo=new WeakSet,Pl=function(){f(this,To,a(this,Ht,be)?.assignedElements().length===0&&a(this,Ht,be)?.assignedNodes().length>0),this.requestUpdate()},ea=new WeakSet,Wn=function(){return this.getRootNode().getElementById(this.trigger?.normalize()??"")},Ro=new WeakSet,Il=function(){let t=a(this,nt);f(this,nt,this.trigger instanceof HTMLElement?this.trigger:typeof this.trigger=="string"?c(this,ea,Wn).call(this):null);for(let o of id)a(this,nt)?(this.removeEventListener(o,this.show),a(this,nt).addEventListener(o,this.show)):(t?.removeEventListener(o,this.show),this.addEventListener(o,this.show));for(let o of nd)a(this,nt)?(this.removeEventListener(o,this.hide),a(this,nt).addEventListener(o,this.hide)):(t?.removeEventListener(o,this.hide),this.addEventListener(o,this.hide))},q.styles=[kn],r([Mo()],q.prototype,"position",2),r([Mo()],q.prototype,"content",2),r([Mo({type:Boolean,attribute:"no-flip"})],q.prototype,"noFlip",2),r([Mo()],q.prototype,"trigger",2),r([Mo({attribute:"flip-behavior",converter:kr})],q.prototype,"flipBehavior",2),r([L],q.prototype,"show",1),r([L],q.prototype,"hide",1),q=r([ad("pf-tooltip")],q)});import{html as Yi}from"lit";import{customElement as Gc}from"lit/decorators/custom-element.js";import{property as Bl}from"lit/decorators/property.js";wt();import{__classPrivateFieldGet as C,__classPrivateFieldSet as Ut}from"tslib";var ll,qt,no,so,Br,ne,co,il,nl,ki,se;function uc(i){return i.length===1&&typeof i[0]=="object"&&i[0]!==null}var _c=i=>e=>i===x.anonymous?!e.hasAttribute("slot"):e.getAttribute("slot")===i,x=class{constructor(e,...t){if(ll.add(this),this.host=e,qt.set(this,new Map),no.set(this,void 0),so.set(this,!1),Br.set(this,new MutationObserver(o=>C(this,nl,"f").call(this,o))),ne.set(this,void 0),co.set(this,{}),il.set(this,o=>{let l=o.target.name;C(this,se,"f").call(this,l),this.host.requestUpdate()}),nl.set(this,async o=>{let l=[];for(let{addedNodes:s,removedNodes:p}of o)for(let d of[...s,...p])d instanceof HTMLElement&&d.slot&&(C(this,se,"f").call(this,d.slot),l.push(d.slot));this.host.requestUpdate()}),se.set(this,o=>{let l=o||x.anonymous,s=C(this,qt,"f").get(l)?.slot?.assignedElements?.()??C(this,ll,"m",ki).call(this,l),p=o?`slot[name="${o}"]`:"slot:not([name])",d=this.host.shadowRoot?.querySelector?.(p)??null,h=!!s.length;C(this,qt,"f").set(l,{elements:s,name:o??"",hasContent:h,slot:d}),C(this,no,"f").log(o,h)}),Ut(this,no,new v(this.host),"f"),uc(t)){let[{slots:o,deprecations:l}]=t;Ut(this,ne,o,"f"),Ut(this,co,l??{},"f")}else t.length>=1?(Ut(this,ne,t,"f"),Ut(this,co,{},"f")):Ut(this,ne,[null],"f");e.addController(this)}async hostConnected(){this.host.addEventListener("slotchange",C(this,il,"f")),Ut(this,so,!1,"f"),C(this,Br,"f").observe(this.host,{childList:!0}),C(this,qt,"f").clear(),C(this,ne,"f").forEach(C(this,se,"f")),Object.values(C(this,co,"f")).forEach(C(this,se,"f")),this.host.requestUpdate(),await this.host.updateComplete,this.host.requestUpdate()}hostUpdated(){C(this,so,"f")||(C(this,ne,"f").forEach(C(this,se,"f")),Ut(this,so,!0,"f"))}hostDisconnected(){C(this,Br,"f").disconnect()}hasSlotted(...e){return e.length?e.some(t=>C(this,qt,"f").get(t)?.hasContent??!1):(C(this,no,"f").warn("Please provide at least one slot name for which to search."),!1)}getSlotted(...e){return e.length?e.flatMap(t=>C(this,qt,"f").get(t)?.elements??[]):C(this,qt,"f").get(x.anonymous)?.elements??[]}};qt=new WeakMap,no=new WeakMap,so=new WeakMap,Br=new WeakMap,ne=new WeakMap,co=new WeakMap,il=new WeakMap,nl=new WeakMap,se=new WeakMap,ll=new WeakSet,ki=function(e){return Array.from(this.host.children).filter(_c(e))};x.anonymous=Symbol("anonymous slot");import{LitElement as $i,html as Yt}from"lit";import{property as ul}from"lit/decorators/property.js";St();wt();import{LitElement as Wc,html as Lc}from"lit";import{property as Mc}from"lit/decorators/property.js";import{LitElement as Cc,html as Bc}from"lit";import{property as kc}from"lit/decorators/property.js";function Q(i="pfe"){return`${i}-${Math.random().toString(36).substr(2,9)}`}import{css as xc}from"lit";var yc=xc`:host{display:none;overflow:hidden;will-change:height}:host([expanded]){display:block;position:relative}:host(.animating){display:block;transition:height .3s ease-in-out}:host([fixed]){overflow-y:auto}.body{position:relative;overflow:hidden}.body:after{content:"";position:absolute;top:0;bottom:0;left:0}`,Li=yc;var zt=class extends Cc{constructor(){super(...arguments);this.expanded=!1}connectedCallback(){super.connectedCallback(),this.id||(this.id=Q(this.localName)),this.setAttribute("role","region")}render(){return Bc`
      <div tabindex="-1">
    ...
    `}};zt.styles=[Li],r([kc({type:Boolean,reflect:!0})],zt.prototype,"expanded",2);import{__classPrivateFieldGet as g,__classPrivateFieldSet as wr}from"tslib";var z,ht,Gt,mo,J,po,sl,fo,wc=i=>!!i&&!i.hasAttribute("disabled")&&!i.ariaHidden&&!i.hasAttribute("hidden"),Vt=class{get activeItem(){return g(this,ht,"f")}get firstItem(){return g(this,z,"a",J)[0]}get lastItem(){return g(this,z,"a",J).at(-1)}get nextItem(){return g(this,z,"a",po)>=g(this,z,"a",J).length-1?this.firstItem:g(this,z,"a",J)[g(this,z,"a",po)+1]}get prevItem(){return g(this,z,"a",po)>0?g(this,z,"a",J)[g(this,z,"a",po)-1]:this.lastItem}constructor(e){z.add(this),this.host=e,ht.set(this,void 0),Gt.set(this,void 0),mo.set(this,[]),fo.set(this,t=>{if(t.ctrlKey||t.altKey||t.metaKey||!g(this,z,"a",J).length||!t.composedPath().some(p=>g(this,z,"a",J).includes(p)))return;let o=this.activeItem,l=!1,s=o?o.tagName==="SELECT"||o.getAttribute("role")==="spinbutton":!1;switch(t.key){case"ArrowLeft":this.focusOnItem(this.prevItem),l=!0;break;case"ArrowRight":this.focusOnItem(this.nextItem),l=!0;break;case"ArrowUp":if(s)return;this.focusOnItem(this.prevItem),l=!0;break;case"ArrowDown":if(s)return;this.focusOnItem(this.nextItem),l=!0;break;case"Home":this.focusOnItem(this.firstItem),l=!0;break;case"PageUp":if(s)return;this.focusOnItem(this.firstItem),l=!0;break;case"End":this.focusOnItem(this.lastItem),l=!0;break;case"PageDown":if(s)return;this.focusOnItem(this.lastItem),l=!0;break;default:break}l&&(t.stopPropagation(),t.preventDefault())}),this.host.addController(this)}updateActiveItem(e){e&&(g(this,ht,"f")&&e!==g(this,ht,"f")&&(g(this,ht,"f").tabIndex=-1),e.tabIndex=0,wr(this,ht,e,"f"))}focusOnItem(e){this.updateActiveItem(e||this.firstItem),g(this,ht,"f")?.focus(),this.host.requestUpdate()}updateItems(e){let o=[...e.slice(g(this,z,"a",sl)),...e.slice(0,g(this,z,"a",sl))].find(l=>g(this,z,"a",J).includes(l));this.focusOnItem(o||this.firstItem)}initItems(e,t=this.host){wr(this,mo,e??[],"f");let o=g(this,z,"a",J),[l]=o;wr(this,ht,l,"f");for(let s of o)s.tabIndex=g(this,ht,"f")===s?0:-1;(!g(this,Gt,"f")||t!==g(this,Gt,"f"))&&(g(this,Gt,"f")?.removeEventListener("keydown",g(this,fo,"f")),wr(this,Gt,t,"f"),this.hostConnected())}hostConnected(){g(this,Gt,"f")?.addEventListener("keydown",g(this,fo,"f"))}hostDisconnected(){g(this,Gt,"f")?.removeEventListener("keydown",g(this,fo,"f"))}};ht=new WeakMap,Gt=new WeakMap,mo=new WeakMap,fo=new WeakMap,z=new WeakSet,J=function(){return g(this,mo,"f").filter(wc)},po=function(){return g(this,z,"a",J)&&this.activeItem?g(this,z,"a",J).indexOf(this.activeItem):-1},sl=function(){return this.activeItem?g(this,mo,"f").indexOf(this.activeItem):-1};import{css as Sc}from"lit";var zc=Sc`:host{transition-property:box-shadow,border;transition-timing-function:ease-out;transition-duration:1ms}`,Mi=zc;var Tc=/^[0-9.]+(?<unit>[a-zA-Z]+)/g,cl=class extends B{constructor(t,o){super("expand");this.toggle=t;this.panel=o}},pl=class extends B{constructor(t,o){super("collapse");this.toggle=t;this.panel=o}},Tr,Ti,go,ce,bo,dl,ho,Er,vo,Rr,Fr,uo,fl,$r,Ei,Me,Sr,Te,zr,Ee,Wr,_o,ml,xo,gl,yo,bl,Co,hl,Hr,Ri,Re,Lr,Bo,vl,Fe,Mr,Wt=class extends Wc{constructor(){super(...arguments);n(this,bo);n(this,uo);n(this,$r);n(this,Me);n(this,Te);n(this,Ee);n(this,_o);n(this,xo);n(this,yo);n(this,Co);n(this,Hr);n(this,Re);n(this,Bo);n(this,Fe);n(this,go,new Vt(this));n(this,ce,[]);this.expandedSets=new Set;n(this,ho,new v(this));n(this,Er,getComputedStyle(this));n(this,vo,c(this,yo,bl).call(this));n(this,Rr,!1);n(this,Fr,new MutationObserver(()=>c(this,uo,fl).call(this)))}static isAccordion(t){return t instanceof Wt}static isHeader(t){return t instanceof tt}static isPanel(t){return t instanceof zt}get expandedIndex(){return a(this,ce)}set expandedIndex(t){let o=a(this,ce);f(this,ce,t),JSON.stringify(o)!==JSON.stringify(t)&&(this.requestUpdate("expandedIndex",o),this.collapseAll().then(async()=>{for(let l of this.expandedIndex)await this.expand(l,this)}))}get headers(){return c(this,Re,Lr).call(this)}get panels(){return c(this,Bo,vl).call(this)}async getUpdateComplete(){let t=await super.getUpdateComplete(),o=await Promise.all([...c(this,Re,Lr).call(this).map(l=>l.updateComplete),...c(this,Bo,vl).call(this).map(l=>l.updateComplete)]);return t&&o.every(Boolean)}connectedCallback(){super.connectedCallback(),this.addEventListener("change",c(this,Hr,Ri)),a(this,Fr).observe(this,{childList:!0}),c(this,uo,fl).call(this)}render(){return Lc`
      <slot></slot>
    `}async firstUpdated(){let{headers:t}=this;t.forEach((o,l)=>{if(o.expanded){c(this,Te,zr).call(this,o,l);let s=c(this,Me,Sr).call(this,o);s&&c(this,Ee,Wr).call(this,s)}})}updateAccessibility(){let{headers:t}=this;t.forEach(o=>{let l=c(this,Me,Sr).call(this,o);l&&(o.setAttribute("aria-controls",l.id),l.setAttribute("aria-labelledby",o.id),l.hidden=!l.expanded)})}async toggle(t){let{headers:o}=this;o[t].expanded?await this.collapse(t):await this.expand(t)}async expand(t,o){let s=c(this,Re,Lr).call(this,o)[t];if(!s)return;let p=c(this,Me,Sr).call(this,s);p&&(c(this,Te,zr).call(this,s,t),c(this,Ee,Wr).call(this,p),s.focus(),this.dispatchEvent(new cl(s,p)),await this.updateComplete)}async expandAll(){this.headers.forEach(t=>c(this,Te,zr).call(this,t)),this.panels.forEach(t=>c(this,Ee,Wr).call(this,t)),await this.updateComplete}async collapse(t){let o=this.headers.at(t),l=this.panels.at(t);!o||!l||(c(this,_o,ml).call(this,o),c(this,xo,gl).call(this,l),this.dispatchEvent(new pl(o,l)),await this.updateComplete)}async collapseAll(){this.headers.forEach(t=>c(this,_o,ml).call(this,t)),this.panels.forEach(t=>c(this,xo,gl).call(this,t)),await this.updateComplete}},vt=Wt;Tr=new WeakSet,Ti=function(t){return t instanceof ko},go=new WeakMap,ce=new WeakMap,bo=new WeakSet,dl=function(){let{headers:t}=this,o=t.findIndex(l=>l.matches(":focus,:focus-within"));return o>-1?t.at(o):void 0},ho=new WeakMap,Er=new WeakMap,vo=new WeakMap,Rr=new WeakMap,Fr=new WeakMap,uo=new WeakSet,fl=async function(){a(this,Rr)||f(this,Rr,!!await this.updateComplete),a(this,go).initItems(this.headers),this.addEventListener("focusin",c(this,$r,Ei)),this.updateAccessibility()},$r=new WeakSet,Ei=function(t){a(this,bo,dl)&&a(this,go).updateActiveItem(a(this,bo,dl))},Me=new WeakSet,Sr=function(t){let o=t.nextElementSibling;return Wt.isPanel(o)?o:void a(this,ho).error("Sibling element to a header needs to be a panel")},Te=new WeakSet,zr=function(t,o=c(this,Fe,Mr).call(this,t)){this.expandedSets.add(o),f(this,ce,[...this.expandedSets]),t.expanded=!0},Ee=new WeakSet,Wr=async function(t){t.expanded=!0,t.hidden=!1,await t.updateComplete;let o=t.getBoundingClientRect();c(this,Co,hl).call(this,t,0,o.height)},_o=new WeakSet,ml=async function(t,o=c(this,Fe,Mr).call(this,t)){this.expandedSets||await this.updateComplete,this.expandedSets.delete(o),t.expanded=!1,await t.updateComplete},xo=new WeakSet,gl=async function(t){if(await t.updateComplete,!t.expanded)return;let o=t.getBoundingClientRect();t.expanded=!1,t.hidden=!0,c(this,Co,hl).call(this,t,o.height,0),await t.updateComplete},yo=new WeakSet,bl=function(){if("computedStyleMap"in this)return this.computedStyleMap().get("transition-duration")?.to("ms").value;{let{transitionDuration:t}=a(this,Er),o=Tc.exec(t)?.groups;if(!o)return 0;let l=parseFloat(t);return o.unit==="s"?l*1e3:l}},Co=new WeakSet,hl=async function(t,o,l){if(t){let s=t.previousElementSibling,p=c(this,yo,bl).call(this);p&&f(this,vo,p);let d=a(this,vo)??0;s?.classList.add("animating"),t.classList.add("animating");let h=t.animate({height:[`${o}px`,`${l}px`]},{duration:d});h.play(),await h.finished,s?.classList.remove("animating"),t.classList.remove("animating"),t.style.removeProperty("height"),t.hidden=!t.expanded}},Hr=new WeakSet,Ri=function(t){var o;if(c(o=Wt,Tr,Ti).call(o,t)&&!this.classList.contains("animating")){let l=c(this,Fe,Mr).call(this,t.target);t.expanded?this.expand(l,t.accordion):this.collapse(l)}},Re=new WeakSet,Lr=function(t=this){return Array.from(t.children).filter(Wt.isHeader)},Bo=new WeakSet,vl=function(t=this){return Array.from(t.children).filter(Wt.isPanel)},Fe=new WeakSet,Mr=function(t){return Wt.isHeader(t)?this.headers.findIndex(o=>o.id===t.id):Wt.isPanel(t)?this.panels.findIndex(o=>o.id===t.id):(a(this,ho).warn("The #getIndex method expects to receive a header or panel element."),-1)},n(vt,Tr),vt.styles=[Mi],r([Mc({attribute:"expanded-index",converter:Wi})],vt.prototype,"expandedIndex",1);St();wt();import{css as Ec}from"lit";var Rc=Ec`#heading{font-size:100%;padding:0;margin:0}a,button{cursor:pointer}.toggle,.toggle:after,.toggle:before{padding:0;margin:0}.toggle{position:relative;display:flex;align-items:center;justify-content:space-between;width:100%;border:0}.toggle:after{content:"";position:absolute;bottom:0;left:0}span{overflow:hidden;text-overflow:ellipsis;white-space:nowrap}`,Fi=Rc;var Fc=i=>i instanceof HTMLElement&&!!i.tagName.match(/P|^H[1-6]/),ko=class extends B{constructor(t,o,l){super("change");this.expanded=t;this.toggle=o;this.accordion=l}},ut,pe,$e,Pr,Hi,_t,Xt,Ir,Pi,Or,Ii,tt=class extends $i{constructor(){super(...arguments);n(this,Pr);n(this,_t);n(this,Ir);n(this,Or);this.expanded=!1;n(this,ut,void 0);n(this,pe,new v(this));n(this,$e,void 0)}connectedCallback(){super.connectedCallback(),this.addEventListener("click",c(this,Or,Ii)),this.hidden=!0,this.id||(this.id=Q(this.localName)),c(this,Pr,Hi).call(this)}render(){switch(this.headingTag){case"h1":return Yt`<h1 id="heading">${c(this,_t,Xt).call(this)}</h1>`;case"h2":return Yt`<h2 id="heading">${c(this,_t,Xt).call(this)}</h2>`;case"h3":return Yt`<h3 id="heading">${c(this,_t,Xt).call(this)}</h3>`;case"h4":return Yt`<h4 id="heading">${c(this,_t,Xt).call(this)}</h4>`;case"h5":return Yt`<h5 id="heading">${c(this,_t,Xt).call(this)}</h5>`;case"h6":return Yt`<h6 id="heading">${c(this,_t,Xt).call(this)}</h6>`;default:return c(this,_t,Xt).call(this)}}};ut=new WeakMap,pe=new WeakMap,$e=new WeakMap,Pr=new WeakSet,Hi=async function(){this.headingText&&!this.headingTag&&(this.headingTag="h3"),f(this,$e,c(this,Ir,Pi).call(this)),a(this,$e)!==a(this,ut)&&f(this,ut,void 0);do await this.updateComplete;while(!await this.updateComplete);this.hidden=!1},_t=new WeakSet,Xt=function(){let t=this.headingText?.trim()??a(this,$e)?.textContent?.trim();return Yt`
      <button id="button"
              class="toggle"
    ...
    `},Ir=new WeakSet,Pi=function(){if(!this.firstElementChild&&!this.firstChild)return void a(this,pe).warn("No header content provided");if(this.firstElementChild){let[t,...o]=Array.from(this.children).filter(l=>!l.hasAttribute("slot")&&Fc(l));if(t)o.length&&a(this,pe).warn("Heading currently only supports 1 tag; extra tags will be ignored.");else return void a(this,pe).warn("No heading information was provided.");return t}else return a(this,ut)||a(this,pe).warn("Header should contain at least 1 heading tag for correct semantics."),f(this,ut,document.createElement("h3")),this.firstChild?.nodeType===Node.TEXT_NODE?a(this,ut).textContent=this.firstChild.textContent:a(this,ut).textContent=this.textContent,a(this,ut)},Or=new WeakSet,Ii=function(t){let o=!this.expanded,l=t.composedPath().find(vt.isAccordion);l&&this.dispatchEvent(new ko(o,this,l))},tt.styles=[Fi],tt.shadowRootOptions={...$i.shadowRootOptions,delegatesFocus:!0},r([ul({type:Boolean,reflect:!0})],tt.prototype,"expanded",2),r([ul({reflect:!0,attribute:"heading-text"})],tt.prototype,"headingText",2),r([ul({reflect:!0,attribute:"heading-tag"})],tt.prototype,"headingTag",2);import{css as $c}from"lit";var Hc=$c`:host{--pf-icon--size:var(--pf-c-accordion__toggle--IconSize, 10px);color:var(--pf-c-accordion__toggle--Color,var(--pf-global--Color--100,#151515));background-color:var(--pf-global--BackgroundColor--100,#fff)}:host([large]){--pf-c-accordion__toggle--PaddingTop:var(--pf-global--spacer--md, 1rem);--pf-c-accordion__toggle--PaddingRight:var(--pf-global--spacer--md, 1rem);--pf-c-accordion__toggle--PaddingBottom:var(--pf-global--spacer--md, 1rem);--pf-c-accordion__toggle--PaddingLeft:var(--pf-global--spacer--lg, 1.5rem);--pf-c-accordion__toggle--FontFamily:var(--pf-global--FontFamily--redhat-updated--heading--sans-serif,
      ...
      <pf-icon part="icon"
                ...
                class="icon"
                size="lg"></pf-icon>
    `}};Nr=new WeakMap,Zt.styles=[...tt.styles,Oi],r([Bl({reflect:!0})],Zt.prototype,"bordered",2),r([Bl({reflect:!0})],Zt.prototype,"icon",2),r([Bl({reflect:!0,attribute:"icon-set"})],Zt.prototype,"iconSet",2),Zt=r([Gc("pf-accordion-header")],Zt);import{customElement as Xc}from"lit/decorators/custom-element.js";import{property as Kc}from"lit/decorators/property.js";import{css as Vc}from"lit";var Yc=Vc`:host{color:var(--pf-global--Color--100,#151515);background-color:var(--pf-c-accordion--BackgroundColor,var(--pf-global--BackgroundColor--light-100,#fff))}.body{padding:var(--pf-c-accordion__panel-body--PaddingTop,var(--pf-global--spacer--sm,.5rem)) var(--pf-c-accordion__panel-body--PaddingRight,var(--pf-global--spacer--md,1rem)) var(--pf-c-accordion__panel-body--PaddingBottom,var(--pf-global--spacer--sm,.5rem)) var(--pf-c-accordion__panel-body--PaddingLeft,var(--pf-global--spacer--md,1rem))}.body:after{width:var(--pf-c-accordion__panel-body--before--Width,var(--pf-global--BorderWidth--lg,3px));background-color:var(--pf-c-accordion__panel-body--before--BackgroundColor,transparent)}:host([large]){--pf-c-accordion__panel-body--PaddingTop:var(--pf-c-accordion--m-display-lg__expanded-content-body--PaddingTop, 0);--pf-c-accordion__panel-body--PaddingRight:var(--pf-c-accordion--m-display-lg__expanded-content-body--PaddingRight, 1rem);--pf-c-accordion__panel-body--PaddingBottom:var(--pf-c-accordion--m-display-lg__expanded-content-body--PaddingBottom, 1.5rem);--pf-c-accordion__panel-body--PaddingLeft:var(--pf-c-accordion--m-display-lg__expanded-content-body--PaddingLeft, 1.5rem);--pf-c-accordion__panel--FontSize:var(--pf-c-accordion--m-display-lg__expanded-content--FontSize, 1rem);--pf-c-accordion__panel--Color:var(--pf-c-accordion--m-display-lg__expanded-content--Color, #151515)}:host([large]) .body:last-child{--pf-c-accordion__panel-body--PaddingBottom:var(--pf-c-accordion--m-display-lg__expanded-content-body--last-child--PaddingBottom, 1.5rem)}.content{color:var(--pf-c-accordion__panel--Color,var(--pf-global--Color--dark-200,#6a6e73));font-size:var(--pf-c-accordion__panel--FontSize, var(--pf-global--FontSize--sm, .875rem))}:host([fixed]){max-height:var(--pf-c-accordion__panel--m-fixed--MaxHeight,9.375rem)}.content[expanded],:host([expanded]) .content{--pf-c-accordion__panel-body--before--BackgroundColor:var(
      --pf-c-accordion__panel--content-body--before--BackgroundColor,
      var(--pf-global--primary-color--100, #0066cc))}`,Xi=Yc;var Pe=class extends zt{};Pe.styles=[...zt.styles,Xi],r([Kc({reflect:!0})],Pe.prototype,"bordered",2),Pe=r([Xc("pf-accordion-panel")],Pe);wo();wo();import{__decorate as Zc}from"tslib";function Ki(i,e,t=!1){let o;return function(...l){let s=this,p=function(){o=null,t||i.apply(s,l)},d=t&&!o;clearTimeout(o),o=window.setTimeout(p,e),d&&i.apply(s,l)}}wt();var lt=class{constructor(e,t){this.host=e,this.options=t,this.mo=new MutationObserver(this.parse),this.cache=new Map,this.class=e.constructor,this.logger=new v(this.host),lt.instances.set(e,this);let o=this.options?.properties??{};for(let[l,s]of Object.entries(o))this.initProp(l,s);e.addController(this),this.cascadeProperties=Ki(this.cascadeProperties,1)}hostUpdated(){this.cascadeProperties()}hostConnected(){this.mo.observe(this.host,{attributes:!0,childList:!0}),this.cascadeProperties()}hostDisconnected(){this.mo.disconnect()}cascadeProperties(e=this.host.children){if(this.host.isConnected){let t=this.cache.keys();if(!e)return this._cascadeAttributes(t,this.cache);for(let o of e)if(o instanceof Element){for(let l of t)if(o.matches(l)){let s=this.cache.get(l);for(let p of s??[])this._copyAttribute(p,o)}}}}initProp(e,t){for(let o of[t].flat(1/0).filter(Boolean)){let{attribute:l}=this.class.getPropertyOptions(e),s=typeof l=="string"?l:e.toLowerCase();this.cache.get(o)?this.cache.get(o)?.push(s):this.cache.set(o,[s])}}parse(e){for(let t of e??[])t.type==="childList"&&t.addedNodes.length?this.cascadeProperties(t.addedNodes):t.type==="attributes"&&this._cascadeAttributes(this.cache.keys(),this.cache)}async _copyAttribute(e,t){this.logger.log(`copying ${e} to ${t}`);let o=this.host.getAttribute(e);t.isConnected&&(o==null?t.removeAttribute(e):t.setAttribute(e,o))}_cascadeAttributes(e,t){for(let o of e)for(let l of t.get(o)??[])this._cascadeAttribute(l,o)}_cascadeAttribute(e,t){let o=[...this.host.querySelectorAll(t),...this.host.shadowRoot?.querySelectorAll(t)??[]];for(let l of o)this._copyAttribute(e,l)}};lt.instances=new WeakMap;Zc([L],lt.prototype,"parse",null);function So(...i){return function(e,t){e.constructor.addInitializer(o=>{let l=o;lt.instances.has(l)||lt.instances.set(l,new lt(l)),lt.instances.get(l)?.initProp(t,i)})}}wt();function Zi(i){return function(e,t){let{alias:o,...l}=i,s=e.constructor,p=s.getPropertyOptions(o);s.createProperty(t,{...p,...l}),s.addInitializer(d=>{d.addController(new kl(d,i,t))})}}var kl=class{constructor(e,t,o){this.host=e,this.options=t,this.deprecatedKey=o,this.logged=!1,this.logger=new v(e)}hostUpdate(){let{deprecatedKey:e,options:{alias:t}}=this;this.host[e]&&this.host[t]!==this.host[e]&&(this.logged||(this.logger.warn(`${e} is deprecated, use ${t} instead`),this.logged=!0),this.host[t]=this.host[e])}};wt();var Ur=class{constructor(e,t,o){this.host=e,this.options=o,this.initializer=t.bind(e),this.mo=new MutationObserver(this.initializer),this.logger=new v(this.host),e.addController(this)}hostConnected(){this.hasLightDOM()?this.initializer():this.options?.emptyWarning&&this.logger.warn(this.options?.emptyWarning),this.initObserver()}hostDisconnected(){this.mo.disconnect()}initObserver(){(this.options?.observe??!0)&&this.mo.observe(this.host,typeof this.options?.observe!="object"?{childList:!0}:this.options?.observe)}hasLightDOM(){return this.host.children.length>0||(this.host.textContent??"").trim().length>0}};function Qi(i){return function(e,t){e.constructor.addInitializer(o=>{let l=e[t],s=new Ur(o,l,i);o.isConnected&&s.hostConnected()})}}var wl=Symbol("observed properties controller"),Mt=class{delete(e){this.values.delete(e)}constructor(e){if(this.host=e,this.values=new Map,Mt.hosts.get(e))return Mt.hosts.get(e);e.addController(this),e[wl]=this}hostUpdate(){for(let[e,[t,[o,l]]]of this.values)this.host[t]?.(o,l),this.delete(e)}hostUpdated(){this.host.removeController(this)}cache(e,t,...o){this.values.set(e,[t,o])}};Mt.hosts=new WeakMap;function et(...i){if(i.length===1){let[e]=i;return function(t,o){t.constructor.addInitializer(l=>new Mt(l)),Ji(t,o,e)}}else{let[e,t]=i;e.constructor.addInitializer(o=>new Mt(o)),Ji(e,t)}}function Ji(i,e,t){let o=Object.getOwnPropertyDescriptor(i,e);Object.defineProperty(i,e,{...o,configurable:!0,set(l){let s=this[e];if(o?.set?.call(this,l),typeof t=="function")t.call(this,s,l);else{let p=t||`_${e}Changed`;this.hasUpdated?this[p]?.(s,l):this[wl].cache(e,p,s,l)}}})}import{property as qr}from"lit/decorators/property.js";import{customElement as tp}from"lit/decorators/custom-element.js";import{css as Qc}from"lit";var Jc=Qc`:host{--accordion__bordered--Color:var(--rh-color-black-300, #d2d2d2);color:var(--pf-global--Color--100,#151515);background-color:var(--pf-global--BackgroundColor--100,#fff)}:host([bordered]) ::slotted(pf-accordion-header:first-child),:host([large]) ::slotted(pf-accordion-header:first-child){display:block;border-top:1px solid var(--accordion__bordered--Color);border-bottom:1px solid var(--accordion__bordered--Color)}:host([bordered]) ::slotted(pf-accordion-header:not(:first-child)),:host([large]) ::slotted(pf-accordion-header:not(:first-child)){display:block;border-bottom:1px solid var(--accordion__bordered--Color)}:host([bordered]) ::slotted(pf-accordion-header:is([expanded])),:host([large]) ::slotted(pf-accordion-header:is([expanded])){display:block;border-bottom:0}:host([bordered]) ::slotted(pf-accordion-panel:is([expanded])),:host([large]) ::slotted(pf-accordion-panel:is([expanded])){display:block;border-bottom:1px solid var(--accordion__bordered--Color)}`,tn=Jc;var Tt=class extends vt{constructor(){super(...arguments);this.single=!1;this.bordered=!1;this.large=!1;this.fixed=!1}async firstUpdated(){let t=null;if(this.single){let o=[...this.querySelectorAll("pf-accordion-header")],l=o.filter(s=>s.hasAttribute("expanded")).pop();l&&(t=o.indexOf(l))}await super.firstUpdated(),t!==null&&this.headers.forEach((o,l)=>{this.headers.at(l)?.toggleAttribute("expanded",l===t),this.panels.at(l)?.toggleAttribute("expanded",l===t)})}async expand(t,o){if(t===-1)return;let l=this.headers;this.single&&await Promise.all([...l.map((s,p)=>s.expanded&&this.collapse(p))]),await super.expand(t,o)}};Tt.styles=[...vt.styles,tn],r([qr({reflect:!0,type:Boolean})],Tt.prototype,"single",2),r([qr({type:Boolean,reflect:!0})],Tt.prototype,"bordered",2),r([et(function(){[...this.headers,...this.panels].forEach(e=>e.toggleAttribute("large",this.large))}),qr({type:Boolean,reflect:!0})],Tt.prototype,"large",2),r([qr({type:Boolean,reflect:!0})],Tt.prototype,"fixed",2),Tt=r([tp("pf-accordion")],Tt);import{property as rn}from"lit/decorators/property.js";import{customElement as ip}from"lit/decorators/custom-element.js";import{LitElement as rp,html as Sl}from"lit";import{property as Gr}from"lit/decorators/property.js";import{css as ep}from"lit";var op=ep`:host{display:contents}:host([src]) img,svg{display:inline;object-fit:cover}:host([hidden]){display:none}`,en=op;var zl=class extends Event{constructor(t){super("load",{bubbles:!0,composed:!0});this.originalEvent=t}},Et=class extends rp{constructor(){super(...arguments);this.alt="Avatar image";this.size="sm";this.dark=!1}render(){return this.src!=null?Sl`
      <img
        size=${this.size}
        alt=${this.alt??""}
        @load="${t=>this.dispatchEvent(new zl(t))}"
        src=${this.src}>
    `:this.dark?Sl`
    ...
    `:Sl`
      ...
      `}};Et.styles=[en],r([Gr()],Et.prototype,"src",2),r([Gr({reflect:!0})],Et.prototype,"alt",2),r([Gr({reflect:!0})],Et.prototype,"size",2),r([Gr({type:Boolean,reflect:!0})],Et.prototype,"dark",2);import{css as ap}from"lit";var lp=ap`img,svg{width:var(--pf-c-avatar--Width,24px);height:var(--pf-c-avatar--Height,24px);border-radius:var(--pf-c-avatar--BorderRadius,var(--pf-global--BorderRadius--lg,128px));border:var(--pf-c-avatar--BorderWidth,0) solid var(--pf-c-avatar--BorderColor,var(--pf-global--BorderColor--dark-100,#d2d2d2))}:host([border]) :is(img,svg){--pf-c-avatar--BorderWidth:var(--pf-global--BorderWidth--sm, 1px)}:host([border=dark]) :is(img,svg){--pf-c-avatar--BorderColor:var(--pf-c-avatar--m-dark--BorderColor,
      var(--pf-global--palette--black-700, #4f5255))}:host([size=sm]){--pf-c-avatar--Width:var(--pf-c-avatar--m-sm--Width, 24px);--pf-c-avatar--Height:var(--pf-c-avatar--m-sm--Height, 24px)}:host([size=md]){--pf-c-avatar--Width:var(--pf-c-avatar--m-md--Width, 36px);--pf-c-avatar--Height:var(--pf-c-avatar--m-md--Height, 36px)}:host([size=lg]){--pf-c-avatar--Width:var(--pf-c-avatar--m-lg--Width, 72px);--pf-c-avatar--Height:var(--pf-c-avatar--m-lg--Height, 72px)}:host([size=xl]){--pf-c-avatar--Width:var(--pf-c-avatar--m-xl--Width, 128px);--pf-c-avatar--Height:var(--pf-c-avatar--m-xl--Height, 128px)}`,on=lp;var fe=class extends Et{constructor(){super(...arguments);this.size="sm"}};fe.styles=[on],r([rn({reflect:!0})],fe.prototype,"size",2),r([rn({reflect:!0})],fe.prototype,"border",2),fe=r([ip("pf-avatar")],fe);import{customElement as mp}from"lit/decorators/custom-element.js";import{property as Wl}from"lit/decorators/property.js";import{LitElement as cp,html as pp}from"lit";import{css as np}from"lit";var sp=np`:host{position:relative;white-space:nowrap;text-align:center;display:inline-block}`,an=sp;var Ie=class extends cp{render(){let{threshold:e,number:t,textContent:o}=this,l=e&&t&&e<t?`${e.toString()}+`:t!=null?t.toString():o??"";return pp`
      <span>${l}</span>
    `}};Ie.styles=[an];import{css as dp}from"lit";var fp=dp`:host{border-radius:var(--pf-c-badge--BorderRadius,var(--pf-global--BorderRadius--lg,180em));min-width:var(--pf-c-badge--MinWidth,var(--pf-global--spacer--xl,2rem));padding-left:var(--pf-c-badge--PaddingLeft,var(--pf-global--spacer--sm,.5rem));padding-right:var(--pf-c-badge--PaddingRight,var(--pf-global--spacer--sm,.5rem));font-size:var(--pf-c-badge--FontSize,
    ...
    `}async formDisabledCallback(){await this.updateComplete,this.requestUpdate()}};Ae=new WeakMap,Xr=new WeakSet,mn=function(){switch(this.type){case"reset":return a(this,Ae).reset();default:return a(this,Ae).submit()}},D.styles=[dn],D.formAssociated=!0,D.shadowRootOptions={...fn.shadowRootOptions,delegatesFocus:!0},r([Oe({reflect:!0,type:Boolean})],D.prototype,"disabled",2),r([Oe({reflect:!0})],D.prototype,"type",2),r([Oe()],D.prototype,"label",2),r([Oe()],D.prototype,"value",2),r([Oe()],D.prototype,"name",2),r([Oe()],D.prototype,"icon",2);xt();import{html as Lp}from"lit";import{customElement as Mp}from"lit/decorators/custom-element.js";import{styleMap as Tp}from"lit/directives/style-map.js";import{LitElement as wp,html as Sp}from"lit";import{property as bn}from"lit/decorators/property.js";import{css as Bp}from"lit";var kp=Bp`:host{display:inline-block;width:min-content;min-height:0;aspect-ratio:1/1}svg{overflow:hidden}circle{width:100%;height:100%;transform-origin:50% 50%;stroke-linecap:round;stroke-dasharray:283;stroke-dashoffset:280}`,gn=kp;var te=class extends wp{constructor(){super(...arguments);this.size="xl"}render(){return Sp`
      <svg role="progressbar" viewBox="0 0 100 100">
        <circle cx="50" cy="50" r="45" fill="none" />
      </svg>
    `}};te.styles=[gn],r([bn({reflect:!0})],te.prototype,"size",2),r([bn({reflect:!0})],te.prototype,"diameter",2);import{css as zp}from"lit";var Wp=zp`[hidden]{display:none!important}div{display:contents}svg{width:var(--pf-c-spinner--Width,var(--pf-c-spinner--diameter,var(--pf-global--icon--FontSize--xl,3.375rem)));height:var(--pf-c-spinner--Height,var(--pf-c-spinner--diameter,var(--pf-global--icon--FontSize--xl,3.375rem)));animation:pf-c-spinner-animation-rotate calc(var(--pf-c-spinner--AnimationDuration,1.4s) * 2) var(--pf-c-spinner--AnimationTimingFunction,linear) infinite}:host([size=sm]) div{--pf-c-spinner--diameter:var(--pf-c-spinner--m-sm--diameter,
    ...
    var(--pf-global--FontSize--md, 1rem))}:host([danger]) button{color:var(--pf-c-button--m-danger--Color,var(--pf-global--Color--light-100,#fff));background-color:var(--pf-c-button--m-danger--BackgroundColor,var(--pf-global--danger-color--100,#c9190b))}`,vn=Rp;var rt=class extends D{constructor(){super(...arguments);this.loading=!1;this.plain=!1;this.warning=!1;this.danger=!1;this.variant="primary"}get hasIcon(){return!!this.icon||!!this.loading}renderDefaultIcon(){return Fp`
      <pf-icon
          icon="${un(this.icon)}"
          set="${un(this.iconSet)}"
    ...
    var(--pf-global--spacer--sm, 0.5rem));margin-block-start:calc(-1 * var(--pf-c-button--PaddingTop));margin-block-end:calc(-1 * var(--pf-c-button--PaddingBottom))}`,Cn=Vp;xt();oa();var Mn=i=>new Promise(e=>setTimeout(e,i)),Ge,ra,aa,Tn,Fo,Ol,$o,Al,la,En,w=class extends ge{constructor(){super(...arguments);n(this,aa);n(this,Fo);n(this,$o);n(this,la);this.clickTip="Copied";this.hoverTip="Copy";this.textAriaLabel="Copyable input";this.toggleAriaLabel="Show content";this.entryDelay=300;this.exitDelay=1500;this.block=!1;this.code=!1;this.expanded=!1;this.expandable=!1;this.readonly=!1;this.inline=!1;this.compact=!1;this.value="";n(this,Ge,!1);n(this,ra,new MutationObserver(()=>c(this,$o,Al).call(this)))}connectedCallback(){super.connectedCallback(),a(this,ra).observe(this,{characterData:!0}),c(this,$o,Al).call(this)}render(){let{expanded:t,expandable:o,inline:l,compact:s,code:p,block:d,readonly:h}=this;return sd`
      <div class="container ${pd({code:p,expanded:t,inline:l,compact:s,block:d})}">
        <div id="input-group">
          <div id="wrapper">
          ...
          <span ?hidden="${!(l||s)}">${this.value}</span>
          <input
              ?hidden="${l||s}"
              ?disabled="${t||h}"
              .value="${this.value}"
          ...
          <pf-tooltip>
            <pf-button id="copy-button"
                        plain
                        variant="${dd(l||s?void 0:"control")}"
                        label="${this.hoverTip}"
                        size="lg"
                        @click="${this.copy}">
              <pf-icon icon="copy"></pf-icon>
            </pf-button>
            <span slot="content">${a(this,Ge)?this.clickTip:this.hoverTip}</span>
          </pf-tooltip>
    ...
    `}async copy(){await super.copy(),await Mn(this.entryDelay),f(this,Ge,!0),this.requestUpdate(),await Mn(this.exitDelay),f(this,Ge,!1),this.requestUpdate()}};Ge=new WeakMap,ra=new WeakMap,aa=new WeakSet,Tn=function(){this.expanded=!this.expanded},Fo=new WeakSet,Ol=function(t){let{value:o}=t.target||HTMLTextAreaElement;this.value=o},$o=new WeakSet,Al=function(){this.childNodes.length>0&&(this.value=this.getAttribute("value")??c(this,la,En).call(this,Array.from(this.childNodes,t=>t instanceof Element||t instanceof Text?t.textContent??"":"").join("")))},la=new WeakSet,En=function(t){let o=t.replace(/^\n/,""),l=o.match(/^\s+/);return l?o.replace(new RegExp(`^${l[0]}`,"gm"),""):t},w.styles=[...ge.styles,Cn],w.shadowRootOptions={...ge.shadowRootOptions,delegatesFocus:!0},r([j({attribute:"click-tip"})],w.prototype,"clickTip",2),r([j({attribute:"hover-tip"})],w.prototype,"hoverTip",2),r([j({attribute:"text-label"})],w.prototype,"textAriaLabel",2),r([j({attribute:"toggle-label"})],w.prototype,"toggleAriaLabel",2),r([j({type:Number,attribute:"entry-delay"})],w.prototype,"entryDelay",2),r([j({type:Number,attribute:"exit-delay"})],w.prototype,"exitDelay",2),r([j({type:Boolean,reflect:!0})],w.prototype,"block",2),r([j({type:Boolean,reflect:!0})],w.prototype,"code",2),r([j({type:Boolean,reflect:!0})],w.prototype,"expanded",2),r([j({type:Boolean,reflect:!0})],w.prototype,"expandable",2),r([j({type:Boolean,reflect:!0})],w.prototype,"readonly",2),r([j({type:Boolean,reflect:!0})],w.prototype,"inline",2),r([j({type:Boolean,reflect:!0})],w.prototype,"compact",2),r([j()],w.prototype,"value",2),w=r([cd("pf-clipboard-copy")],w);import{html as vd}from"lit";import{customElement as ud}from"lit/decorators/custom-element.js";import{property as _d}from"lit/decorators/property.js";import{classMap as xd}from"lit/directives/class-map.js";import{LitElement as gd}from"lit";import{css as fd}from"lit";var md=fd`:host{display:block}[hidden]{display:none!important}`,Rn=md;var Ve=class extends gd{get content(){let e=this.querySelector("script[type]");return e?.type!=="text/javascript-sample"&&e?.type.match(/(j(ava)?|ecma|live)script/)?"":e?.textContent??""}dedent(e){let t=e.replace(/^\n/,""),o=t.match(/^\s+/);return o?t.replace(new RegExp(`^${o[0]}`,"gm"),""):e}};Ve.styles=[Rn];import{css as bd}from"lit";var hd=bd`:host{background-color:var(--pf-c-code-block--BackgroundColor,#f0f0f0);font-size:var(--pf-c-code-block__pre--FontSize, .875rem);font-family:var(--pf-c-code-block__pre--FontFamily, "Liberation Mono", consolas, "SFMono-Regular", menlo, monaco, "Courier New", monospace)}#container{padding-top:var(--pf-c-code-block__content--PaddingTop,1rem);padding-right:var(--pf-c-code-block__content--PaddingRight,1rem);padding-bottom:var(--pf-c-code-block__content--PaddingBottom,1rem);padding-left:var(--pf-c-code-block__content--PaddingLeft,1rem)}#header{border-bottom:var(--pf-c-code-block__header--BorderBottomWidth,1px) solid var(--pf-c-code-block__header--BorderBottomColor,#d2d2d2)}#container{margin:0}pre{margin:0}slot[name=actions]{display:flex;justify-content:end}#expanded{display:inline}button{display:flex;background:0 0;border:none;padding:6px 16px 6px 0;color:#06c;cursor:pointer;font-size:16px}button svg{color:#151515;margin-right:12px;transition:.2s ease-in 0s}.expanded button svg{transform:rotate(-90deg)}`,Fn=hd;var ia,$n,Ho,Dl,Ye=class extends Ve{constructor(){super(...arguments);n(this,ia);n(this,Ho);this.expanded=!1}render(){let{expanded:t}=this;return vd`
      <div id="header">
        <div id="actions">
          <slot name="actions"></slot>
        </div>
      </div>
      <div id="container" class="${xd({expanded:t})}">
        <pre><code id="content">${this.content}</code><code id="code-block-expand"
          ?hidden="${!t}">${a(this,Ho,Dl)}</code></pre>
        <button ?hidden="${!a(this,Ho,Dl)}"
                @click=${c(this,ia,$n)}
    ...
    `}};ia=new WeakSet,$n=function(){this.expanded=!this.expanded},Ho=new WeakSet,Dl=function(){return this.querySelector("script[data-expand]")?.textContent??""},Ye.styles=[...Ve.styles,Fn],r([_d({type:Boolean,reflect:!0})],Ye.prototype,"expanded",2),Ye=r([ud("pf-code-block")],Ye);xt();import{html as Bd,LitElement as Pn}from"lit";import{customElement as kd}from"lit/decorators/custom-element.js";import{property as In}from"lit/decorators/property.js";import{ifDefined as wd}from"lit/directives/if-defined.js";import{css as yd}from"lit";var Cd=yd`:host{display:block}#container{display:contents}slot:not([name]){display:flex;flex-direction:column;row-gap:var(--pf-global--spacer--md,1rem)}a{position:relative;display:flex;cursor:pointer;flex:1;padding-block-start:var(--pf-c-jump-links__link--PaddingTop,var(--pf-global--spacer--md,1rem));padding-inline-end:var(--pf-c-jump-links__link--PaddingRight,var(--pf-global--spacer--md,1rem));padding-block-end:var(--pf-c-jump-links__link--PaddingBottom,var(--pf-global--spacer--md,1rem));padding-inline-start:var(--pf-c-jump-links__link--PaddingLeft,var(--pf-global--spacer--md,1rem));text-decoration:none;outline-offset:var(--pf-c-jump-links__link--OutlineOffset,calc(-1 * var(--pf-global--spacer--sm,0.5rem)));color:var(--pf-c-jump-links__link-text--Color,var(--pf-global--Color--200,#6a6e73))}a::before{position:absolute;inset:0;pointer-events:none;content:"";border-color:var(--pf-c-jump-links__link--before--BorderColor,transparent);border-style:solid;border-width:var(--pf-c-jump-links__link--before--BorderTopWidth,var(--pf-c-jump-links__list--before--BorderTopWidth,var(--pf-global--BorderWidth--sm,1px))) var(--pf-c-jump-links__link--before--BorderRightWidth,0) var(--pf-c-jump-links__link--before--BorderBottomWidth,0) var(--pf-c-jump-links__link--before--BorderLeftWidth,0)}a:hover{--pf-c-jump-links__link-text--Color:var(--pf-c-jump-links__link--hover__link-text--Color,
    ...
    pfvar(--pf-global--Color--100, #151515))}`,Hn=Cd;var na,sa,On,ca,An,ee=class extends Pn{constructor(){super(...arguments);n(this,sa);n(this,ca);this.active=!1;n(this,na,new it(this,{role:"listitem"}))}connectedCallback(){super.connectedCallback(),this.activeChanged()}render(){return Bd`
      <a href="${wd(this.href)}" @focus="${c(this,ca,An)}" @click="${c(this,sa,On)}">
        <slot></slot>
      </a>
      <slot name="subsection"></slot>
    `}activeChanged(){a(this,na).ariaCurrent=this.active?"location":null}};na=new WeakMap,sa=new WeakSet,On=function(){this.dispatchEvent(new Event("select",{bubbles:!0}))},ca=new WeakSet,An=function(){this.dispatchEvent(new Event("focus",{bubbles:!0}))},ee.styles=[Hn],ee.shadowRootOptions={...Pn.shadowRootOptions,delegatesFocus:!0},r([et("activeChanged"),In({type:Boolean,reflect:!0})],ee.prototype,"active",2),r([In({reflect:!0})],ee.prototype,"href",2),ee=r([kd("pf-jump-links-item")],ee);import{html as Wd,LitElement as Ld}from"lit";import{customElement as Md}from"lit/decorators/custom-element.js";import{css as Sd}from"lit";var zd=Sd`:host{display:block}#container{display:contents;--pf-c-jump-links__list--PaddingTop:0;--pf-c-jump-links__list--PaddingBottom:0;--pf-c-jump-links__link--PaddingTop:var(--pf-c-jump-links__list__list__link--PaddingTop,
    ...
    var(--pf-global--spacer--lg, 1.5rem))}`,Dn=zd;var Po=class extends Ld{render(){return Wd`
      <div id="container" role="listbox">
        <slot></slot>
      </div>
    `}};Po.styles=[Dn],Po=r([Md("pf-jump-links-list")],Po);import{html as Ul,LitElement as Rd}from"lit";import{customElement as Fd}from"lit/decorators/custom-element.js";import{property as Ke}from"lit/decorators/property.js";import{__classPrivateFieldGet as b,__classPrivateFieldSet as R}from"tslib";var F,Uo,pa,he,Io,qo,Xe,Oo,Ao,Do,da,Go,jo,No,jl,Nl,Nn,jn,fa=class{get root(){return b(this,Oo,"f")}set root(e){R(this,Oo,e,"f"),b(this,he,"f")?.disconnect(),b(this,F,"m",No).call(this)}get rootMargin(){return b(this,Ao,"f")}set rootMargin(e){R(this,Ao,e,"f"),b(this,he,"f")?.disconnect(),b(this,F,"m",No).call(this)}get threshold(){return b(this,Do,"f")}set threshold(e){R(this,Do,e,"f"),b(this,he,"f")?.disconnect(),b(this,F,"m",No).call(this)}constructor(e,t){F.add(this),this.host=e,Uo.set(this,void 0),pa.set(this,void 0),he.set(this,void 0),Io.set(this,new Set),qo.set(this,!1),Xe.set(this,!1),Oo.set(this,void 0),Ao.set(this,void 0),Do.set(this,void 0),da.set(this,void 0),Go.set(this,void 0),e.addController(this),R(this,Uo,t.tagNames,"f"),R(this,Oo,t.root,"f"),R(this,Ao,t.rootMargin,"f"),R(this,pa,t.activeAttribute??"active","f"),R(this,Do,t.threshold??.85,"f"),R(this,da,t.rootNode??e.getRootNode(),"f"),R(this,Go,t?.getHash??(o=>o.getAttribute("href")),"f")}hostConnected(){b(this,F,"m",No).call(this)}async setActive(e){R(this,qo,!0,"f"),b(this,F,"m",Nl).call(this,e);let t=!1;for(let o of b(this,F,"a",jo))b(this,F,"m",jl).call(this,o,!t),o===e&&(t=!0);await b(this,F,"m",Nn).call(this),R(this,qo,!1,"f")}};Uo=new WeakMap,pa=new WeakMap,he=new WeakMap,Io=new WeakMap,qo=new WeakMap,Xe=new WeakMap,Oo=new WeakMap,Ao=new WeakMap,Do=new WeakMap,da=new WeakMap,Go=new WeakMap,F=new WeakSet,jo=function(){return Array.from(this.host.querySelectorAll(b(this,Uo,"f").join(","))).filter(b(this,Go,"f"))},No=function(){let e=b(this,da,"f");if(e instanceof Document||e instanceof ShadowRoot){let{rootMargin:t,threshold:o,root:l}=this;R(this,he,new IntersectionObserver(s=>b(this,F,"m",jn).call(this,s),{root:l,rootMargin:t,threshold:o}),"f"),b(this,F,"a",jo).map(s=>b(this,Go,"f").call(this,s)).filter(s=>!!s).map(s=>e.getElementById(s.replace("#",""))).filter(s=>!!s).forEach(s=>b(this,he,"f")?.observe(s))}},jl=function(e,t){t?b(this,Io,"f").add(e):b(this,Io,"f").delete(e)},Nl=function(e){for(let t of b(this,F,"a",jo))t.toggleAttribute(b(this,pa,"f"),t===e)},Nn=async function(){for(R(this,Xe,!1,"f"),setTimeout(()=>R(this,Xe,!1,"f"),3e3);!b(this,Xe,"f");)await new Promise(requestAnimationFrame)},jn=async function(e){if(!b(this,qo,"f")){for(let{target:l,boundingClientRect:s,intersectionRect:p}of e){let d=`:is(${b(this,Uo,"f").join(",")})[href="#${l.id}"]`,h=this.host.querySelector(d);h&&b(this,F,"m",jl).call(this,h,s.top<p.top)}let o=[...b(this,Io,"f")].at(-1);b(this,F,"m",Nl).call(this,o??b(this,F,"a",jo).at(0))}R(this,Xe,!0,"f")};xt();import{css as Td}from"lit";var Ed=Td`[hidden]{display:none!important}:host{display:block}#container{display:flex;flex-wrap:wrap;font-family:var(--pf-global--FontFamily--sans-serif, "RedHatTextUpdated", "Overpass", overpass, helvetica, arial, sans-serif);font-size:var(--pf-global--FontSize--md, 16px);font-weight:var(--pf-global--FontWeight--normal,400)}slot{position:relative;display:var(--pf-c-jump-links__list--Display,flex);flex-direction:var(--pf-c-jump-links__list--FlexDirection,row);padding-block-start:var(--pf-c-jump-links__list--PaddingTop,0);padding-inline-end:var(--pf-c-jump-links__list--PaddingRight,var(--pf-global--spacer--md,1rem));padding-block-end:var(--pf-c-jump-links__list--PaddingBottom,0);padding-inline-start:var(--pf-c-jump-links__list--PaddingLeft,var(--pf-global--spacer--md,1rem));visibility:var(--pf-c-jump-links__list--Visibility,visible)}slot::before{position:absolute;top:0;right:0;bottom:0;left:0;pointer-events:none;content:"";border:solid var(--pf-c-jump-links__list--before--BorderColor,var(--pf-global--BorderColor--100,#d2d2d2));border-width:var(--pf-c-jump-links__list--before--BorderTopWidth,var(--pf-global--BorderWidth--sm,1px)) var(--pf-c-jump-links__list--before--BorderRightWidth,0) var(--pf-c-jump-links__list--before--BorderBottomWidth,0) var(--pf-c-jump-links__list--before--BorderLeftWidth,0)}:host([vertical]) #container{--pf-c-jump-links__list--PaddingTop:var(--pf-c-jump-links--m-vertical__list--PaddingTop,
    ...
    var(--pf-global--spacer--sm, 0.5rem));margin-top:var(--pf-c-label__c-button--MarginTop,-.5rem);margin-right:var(--pf-c-label__c-button--MarginRight,-.5rem);margin-bottom:var(--pf-c-label__c-button--MarginBottom,-.5rem);margin-left:var(--pf-c-label__c-button--MarginLeft,.25rem)}svg{vertical-align:-.125em;fill:currentColor;height:1em;width:1em}`,Yn=Dd;var G=class extends ve{constructor(){super(...arguments);this.variant="filled";this.color="grey";this.compact=!1;this.truncated=!1;this.removable=!1}render(){let{compact:t,truncated:o}=this;return Gl`
      <span id="pf-container" class="${Nd({compact:t,truncated:o})}">${super.render()}</span>
    `}renderDefaultIcon(){return this.icon?Gl`
      <pf-icon icon="${this.icon}" size="sm"></pf-icon>
    `:""}renderSuffix(){return this.removable?Gl`
      <span part="close-button" ?hidden=${!this.removable}>
        <pf-button plain
                    @click="${()=>this.dispatchEvent(new B("close"))}"
    ...
    `:""}};G.styles=[...ve.styles,Yn],G.shadowRootOptions={...ve.shadowRootOptions,delegatesFocus:!0},r([ue()],G.prototype,"variant",2),r([ue()],G.prototype,"color",2),r([ue()],G.prototype,"icon",2),r([ue({type:Boolean})],G.prototype,"compact",2),r([ue({type:Boolean})],G.prototype,"truncated",2),r([ue({type:Boolean})],G.prototype,"removable",2),r([ue({attribute:"close-button-label"})],G.prototype,"closeButtonLabel",2),G=r([jd("pf-label")],G);St();import{LitElement as Kn,html as Gd}from"lit";import{customElement as Vd}from"lit/decorators/custom-element.js";import{property as ba}from"lit/decorators/property.js";import{query as Vl}from"lit/decorators/query.js";import{ifDefined as Zn}from"lit/directives/if-defined.js";import{classMap as Yd}from"lit/directives/class-map.js";import{css as Ud}from"lit";var qd=Ud`:host{display:block;position:relative;--_spacer-align-top:var(--pf-c-modal-box--m-align-top--spacer,
    ...
    var(--pf-global--FontSize--md,
      1rem))}[part=close-button]:is(:focus-within,:focus-visible,:hover){color:var(--pf-c-button--m-plain--focus--Color,var(--pf-global--Color--100,#151515))}[part=close-button]>svg{font-size:16px;width:var(--pf-global--spacer--md,1rem);aspect-ratio:1/1}:host([position=top]) #dialog{align-self:start;margin-block:var(--pf-c-modal-box--m-align-top--MarginTop,var(--pf-c-modal-box--m-align-top--spacer,2rem));margin-inline:var(--pf-global--spacer--md,1rem);width:100%;max-width:var(--pf-c-modal-box--m-align-top--MaxWidth,calc(100% - min(var(--pf-c-modal-box--m-align-top--spacer,2rem) * 2,var(--pf-global--spacer--xl,2rem))));max-height:var(--pf-c-modal-box--m-align-top--MaxHeight,calc(100% - var(--_height-offset) - var(--_spacer-align-top)))}footer{display:flex;align-items:center;gap:var(--pf-global--spacer--xl,.5rem)}`,Xn=qd;var Yl=class extends B{constructor(){super("cancel")}},Xl=class extends B{constructor(){super("close")}},Kl=class extends B{constructor(t){super("open");this.trigger=t}},Ze,$,_e,Zo,xe,Qe,Je,y=class extends Kn{constructor(){super(...arguments);this.open=!1;this.returnValue="";n(this,Ze,Q());n(this,$,null);n(this,_e,null);n(this,Zo,[]);n(this,xe,[]);n(this,Qe,!1);n(this,Je,new x(this,null,"header","description","footer"))}connectedCallback(){super.connectedCallback(),this.addEventListener("keydown",this.onKeydown),this.addEventListener("click",this.onClick)}render(){let t=a(this,_e)||a(this,xe).length?a(this,Ze):void 0,o=a(this,$)?a(this,$).innerText:void 0,l=a(this,Je).hasSlotted("header"),s=a(this,Je).hasSlotted("description"),p=a(this,Je).hasSlotted("footer");return Gd`
      <section ?hidden=${!this.open}>
        ...
        <div id="dialog"
            ...
            tabindex="0"
            role="dialog"
            aria-labelledby=${Zn(t)}
            aria-label=${Zn(o)}
            ?hidden="${!this.open}">
          <div id="container">
            <div id="content" part="content" class=${Yd({hasHeader:l,hasDescription:s,hasFooter:p})}>
              <header part="header">
                <slot name="header"></slot>
    ...
    `}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("keydown",this.onKeydown),a(this,$)?.removeEventListener("click",this.onTriggerClick)}async _init(){await this.updateComplete,f(this,_e,this.querySelector('[slot$="header"]')),f(this,Zo,[...this.querySelectorAll("*:not([slot])")]),f(this,xe,a(this,Zo).filter(t=>t.tagName.slice(0,1)==="H")),a(this,$)&&(a(this,$).addEventListener("click",this.onTriggerClick),this.removeAttribute("hidden")),a(this,_e)?a(this,_e).id=a(this,Ze):a(this,xe).length>0&&(a(this,xe)[0].id=a(this,Ze))}async _openChanged(t,o){t==null||o==null||t==o||(this.open?(document.body.style.overflow="hidden",await this.updateComplete,this.dialog?.focus(),this.dispatchEvent(new Kl(a(this,$)))):(document.body.style.overflow="auto",await this.updateComplete,a(this,$)&&a(this,$).focus(),this.dispatchEvent(a(this,Qe)?new Yl:new Xl)))}_triggerChanged(){this.trigger&&(f(this,$,this.getRootNode().getElementById(this.trigger)),a(this,$)?.addEventListener("click",this.onTriggerClick))}onTriggerClick(t){t.preventDefault(),this.showModal()}onClick(t){let{open:o,overlay:l,dialog:s}=this;if(o){let p=t.composedPath(),{closeOnOutsideClick:d}=this.constructor;d&&p.includes(l)&&!p.includes(s)&&(t.preventDefault(),this.cancel())}}onKeydown(t){switch(t.key){case"Tab":t.target===this.closeButton&&(t.preventDefault(),this.dialog?.focus());return;case"Escape":case"Esc":t.preventDefault(),this.cancel();return;case"Enter":t.target===a(this,$)&&(t.preventDefault(),this.showModal());return}}async cancel(){f(this,Qe,!0),this.open=!1,await this.updateComplete,f(this,Qe,!1)}setTrigger(t){f(this,$,t),a(this,$).addEventListener("click",this.onTriggerClick)}toggle(){this.open=!this.open}show(){this.open=!0}showModal(){this.show()}close(t){typeof t=="string"&&(this.returnValue=t),this.open=!1}};Ze=new WeakMap,$=new WeakMap,_e=new WeakMap,Zo=new WeakMap,xe=new WeakMap,Qe=new WeakMap,Je=new WeakMap,y.shadowRootOptions={...Kn.shadowRootOptions,delegatesFocus:!0},y.styles=[Xn],y.closeOnOutsideClick=!1,r([ba({reflect:!0})],y.prototype,"variant",2),r([Zi({alias:"variant",attribute:"width"})],y.prototype,"width",2),r([ba({reflect:!0})],y.prototype,"position",2),r([et,ba({type:Boolean,reflect:!0})],y.prototype,"open",2),r([et,ba()],y.prototype,"trigger",2),r([Vl("#overlay")],y.prototype,"overlay",2),r([Vl("#dialog")],y.prototype,"dialog",2),r([Vl("#close-button")],y.prototype,"closeButton",2),r([Qi()],y.prototype,"_init",1),r([L],y.prototype,"onTriggerClick",1),r([L],y.prototype,"onClick",1),r([L],y.prototype,"onKeydown",1),r([L],y.prototype,"toggle",1),r([L],y.prototype,"show",1),r([L],y.prototype,"showModal",1),r([L],y.prototype,"close",1),y=r([Vd("pf-modal")],y);import{LitElement as Zd,html as Qd}from"lit";import{customElement as Jd}from"lit/decorators/custom-element.js";import{property as Jn}from"lit/decorators/property.js";import{css as Xd}from"lit";var Kd=Xd`:host{--pf-c-panel--Width:auto;--pf-c-panel--MinWidth:auto;--pf-c-panel--MaxWidth:none;--pf-c-panel--ZIndex:auto;--pf-c-panel--BackgroundColor:var(--pf-global--BackgroundColor--100, #fff);--pf-c-panel--BoxShadow:none;--pf-c-panel--before--BorderWidth:0;--pf-c-panel--before--BorderColor:var(--pf-global--BorderColor--100, #d2d2d2);--pf-c-panel--m-bordered--before--BorderWidth:var(--pf-global--BorderWidth--sm, 1px);--pf-c-panel--m-raised--BoxShadow:var(--pf-global--BoxShadow--md, 0 0.25rem 0.5rem 0rem rgba(3, 3, 3, 0.12), 0 0 0.25rem 0 rgba(3, 3, 3, 0.06));--pf-c-panel--m-raised--ZIndex:var(--pf-global--ZIndex--sm, 200);--pf-c-panel__header--PaddingTop:var(--pf-global--spacer--md, 1rem);--pf-c-panel__header--PaddingRight:var(--pf-global--spacer--md, 1rem);--pf-c-panel__header--PaddingBottom:var(--pf-global--spacer--md, 1rem);--pf-c-panel__header--PaddingLeft:var(--pf-global--spacer--md, 1rem);--pf-c-panel__main--MaxHeight:none;--pf-c-panel__main--Overflow:visible;--pf-c-panel__main-body--PaddingTop:var(--pf-global--spacer--md, 1rem);--pf-c-panel__main-body--PaddingRight:var(--pf-global--spacer--md, 1rem);--pf-c-panel__main-body--PaddingBottom:var(--pf-global--spacer--md, 1rem);--pf-c-panel__main-body--PaddingLeft:var(--pf-global--spacer--md, 1rem);--pf-c-panel__footer--PaddingTop:var(--pf-global--spacer--md, 1rem);--pf-c-panel__footer--PaddingRight:var(--pf-global--spacer--md, 1rem);--pf-c-panel__footer--PaddingBottom:var(--pf-global--spacer--md, 1rem);--pf-c-panel__footer--PaddingLeft:var(--pf-global--spacer--md, 1rem);--pf-c-panel__footer--BoxShadow:none;--pf-c-panel--m-scrollable__main--MaxHeight:18.75rem;--pf-c-panel--m-scrollable__main--Overflow:auto;--pf-c-panel--m-scrollable__footer--BoxShadow:0 -0.3125rem 0.25rem -0.25rem rgba(3, 3, 3, 0.16);position:relative;z-index:var(--pf-c-panel--ZIndex);width:var(--pf-c-panel--Width);min-width:var(--pf-c-panel--MinWidth);max-width:var(--pf-c-panel--MaxWidth);background-color:var(--pf-c-panel--BackgroundColor);box-shadow:var(--pf-c-panel--BoxShadow);display:block}:host([variant=bordered])::before{position:absolute;inset:0;pointer-events:none;content:"";border:var(--pf-c-panel--m-bordered--before--BorderWidth,var(--pf-global--BorderWidth--sm,1px)) solid var(--pf-c-panel--before--BorderColor,var(--pf-global--BorderColor--100,#d2d2d2))}:host([variant=raised])::before{position:absolute;inset:0;pointer-events:none;content:"";box-shadow:var(--pf-c-panel--m-raised--BoxShadow,0 .25rem .5rem 0 rgba(3,3,3,.12),0 0 .25rem 0 rgba(3,3,3,.06));z-index:var(--pf-c-panel--m-raised--ZIndex,var(--pf-global--ZIndex--sm,200))}:host([variant=raised]){--pf-c-panel--BoxShadow:var(--pf-c-panel--m-raised--BoxShadow,
  ...
  )}[part=body]{display:block;word-wrap:break-word}[part=footer]{margin-top:var(--pf-c-popover__footer--MarginTop,var(--pf-global--spacer--md,1rem))}:host([alert-severity=default]){--_header-text-color:var(--pf-c-popover--m-default__title-text--Color, var(--pf-global--default-color--300, #003737));--_header-icon-color:var(--pf-c-popover--m-default__title-icon--Color, var(--pf-global--default-color--200, #009596))}:host([alert-severity=info]){--_header-text-color:var(--pf-c-popover--m-info__title-text--Color, var(--pf-global--info-color--200, #002952));--_header-icon-color:var(--pf-c-popover--m-info__title-icon--Color, var(--pf-global--info-color--100, #2b9af3))}:host([alert-severity=warning]){--_header-icon-color:var(--pf-c-popover--m-warning__title-icon--Color, var(--pf-global--warning-color--100, #f0ab00));--_header-text-color:var(--pf-c-popover--m-warning__title-text--Color, var(--pf-global--warning-color--200, #795600))}:host([alert-severity=success]){--_header-icon-color:var(--pf-c-popover--m-success__title-icon--Color, var(--pf-global--success-color--100, #3e8635));--_header-text-color:var(--pf-c-popover--m-success__title-text--Color, var(--pf-global--success-color--200, #1e4f18))}:host([alert-severity=danger]){--_header-icon-color:var(--pf-c-popover--m-danger__title-icon--Color, var(--pf-global--danger-color--100, #c9190b));--_header-text-color:var(--pf-c-popover--m-danger__title-text--Color, var(--pf-global--danger-color--200, #a30000))}`,ts=ef;var Ql=class extends B{constructor(){super("hide")}},Jl=class extends B{constructor(){super("hidden")}},ti=class extends B{constructor(){super("show")}},ei=class extends B{constructor(){super("shown")}},V,Ce,to,ha,os,Jo,oi,va,rs,m=class extends of{constructor(){super(...arguments);n(this,ha);n(this,Jo);n(this,va);this.position="top";this.noFlip=!1;n(this,V,null);n(this,Ce,new Ue(this,{content:()=>this._popover,arrow:()=>this._arrow,invoker:()=>a(this,V)||this._slottedTrigger}));n(this,to,new x(this,null,"icon","heading","body","footer"))}connectedCallback(){super.connectedCallback(),this.addEventListener("keydown",this.onKeydown)}render(){let{alignment:t,anchor:o,styles:l}=a(this,Ce),s=a(this,to).hasSlotted("footer")||!!this.footer,p=a(this,to).hasSlotted("heading")||!!this.heading,d=a(this,to).hasSlotted("icon")||!!this.icon||!!this.alertSeverity,h=Pt`<h6>${this.heading??""}</h6>`;switch(this.headingLevel){case 2:h=Pt`<h2>${this.heading??""}</h2>`;break;case 3:h=Pt`<h3>${this.heading??""}</h3>`;break;case 4:h=Pt`<h4>${this.heading??""}</h4>`;break;case 5:h=Pt`<h5>${this.heading??""}</h5>`;break}let S=Pt`
      <slot id="heading" name="heading" part="heading" ?hidden=${!p}>${h}</slot>
    `,O=p&&d?Pt`
      <header part="header">
        <span part="icon">
          <slot name="icon">
            <pf-icon icon="${this.icon??m.alertIcons.get(this.alertSeverity)??""}"
                     set="${es(this.iconSet)}"
                     size="md"></pf-icon>
          </slot>
        </span>${this.alertSeverity?Pt`
        <span class="visually-hidden">${this.alertSeverityText??`${this.alertSeverity} alert:`}</span>`:rf}
        ${S}
      </header>
    `:S;return Pt`
      <div id="container"
           ...
           class="${nf({[o]:!!o,[t]:!!t})}">
        <slot id="trigger"
              @slotchange="${c(this,Jo,oi)}"
              @keydown=${this.onKeydown}
              @click=${this.toggle}></slot>
        <dialog id="popover" aria-labelledby="heading" aria-describedby="body" aria-label=${es(this.label)}>
          <div id="arrow"></div>
      ...
      <div id="container" class="${yf({[t??""]:!!t,[o??""]:!!o,[l??""]:!!l,singleLine:h,descriptionTruncated:p})}">
        ...
        `}
          ...
          <span id="progress-span"
                ...
                data-value="${O}"></span>
          `}
      </div>`}};Ba=new WeakMap,er=new WeakSet,li=function(){let{value:t,min:o,max:l}=this,s=Math.round((t-o)/(l-o)*100);return Number.isNaN(s)||s<0?0:Math.min(s,100)},or=new WeakSet,ii=function(){return wf.get(this.variant??"")?.icon},Y.styles=[ps],r([oe({reflect:!0,type:Number})],Y.prototype,"value",2),r([oe()],Y.prototype,"description",2),r([oe({type:Boolean,reflect:!0,attribute:"description-truncated"})],Y.prototype,"descriptionTruncated",2),r([oe({type:Number,reflect:!0})],Y.prototype,"max",2),r([oe({type:Number,reflect:!0})],Y.prototype,"min",2),r([oe()],Y.prototype,"size",2),r([oe({attribute:"measure-location"})],Y.prototype,"measureLocation",2),r([oe()],Y.prototype,"variant",2),Y=r([Cf("pf-progress")],Y);import{customElement as Tf}from"lit/decorators/custom-element.js";import{LitElement as fs,html as Wf}from"lit";import{property as ni}from"lit/decorators/property.js";import{css as Sf}from"lit";var zf=Sf`:host{display:inline-block}svg{fill:currentcolor}[hidden]{display:none!important}:host(:disabled){pointer-events:none;cursor:not-allowed}:host(:disabled) #container{cursor:not-allowed}:host(:disabled:focus-within) #container{outline:0}#container{position:relative;display:inline-flex;align-items:center}#container::before{position:absolute;display:block;content:""}`,ds=zf;var eo,ka,wa,ms,Sa,gs,rr,si,ar,ci,pt=class extends fs{constructor(){super(...arguments);n(this,wa);n(this,Sa);n(this,rr);n(this,ar);n(this,eo,this.attachInternals());n(this,ka,this.hasAttribute("disabled"));this.showCheckIcon=!1;this.checked=!1;this.disabled=a(this,ka)}get labels(){return a(this,eo).labels}connectedCallback(){super.connectedCallback(),this.setAttribute("role","checkbox"),this.addEventListener("click",c(this,wa,ms)),this.addEventListener("keyup",c(this,Sa,gs)),c(this,ar,ci).call(this)}formDisabledCallback(t){this.disabled=t,this.requestUpdate()}render(){return Wf`
    ...
    `}};ir.styles=[hs],ir=r([Hf("pf-caption")],ir);import{LitElement as gm,html as bm}from"lit";import{customElement as hm}from"lit/decorators/custom-element.js";import{styleMap as vm}from"lit/directives/style-map.js";import{state as um}from"lit/decorators/state.js";import{LitElement as Of,html as us,svg as Af}from"lit";import{customElement as Df}from"lit/decorators/custom-element.js";import{property as za}from"lit/decorators/property.js";import{classMap as jf}from"lit/directives/class-map.js";import{css as Pf}from"lit";var If=Pf`:host{font-weight:700;padding:1rem;position:relative}:host(:empty){padding:0}.sortable{padding-inline-end:1.5em}.sortable slot{display:inline;margin-inline-end:1.5em}button{width:100%;padding:var(--pf-c-table--cell--PaddingTop) var(--pf-c-table--cell--PaddingRight) var(--pf-c-table--cell--PaddingBottom) var(--pf-c-table--cell--PaddingLeft);font-size:inherit;font-weight:inherit;color:var(--pf-c-table__button--Color);text-align:left;white-space:inherit;-webkit-user-select:text;-moz-user-select:text;-ms-user-select:text;user-select:text;background-color:var(--pf-c-table__button--BackgroundColor);border:0}button::before{position:absolute;inset:0;cursor:pointer;content:''}button:hover{--pf-c-table__sort-indicator--Color:var(--pf-c-table__sort__button--hover__sort-indicator--Color);--pf-c-table__sort__button__text--Color:var(--pf-c-table__sort__button--hover__text--Color)}button:active{--pf-c-table__sort-indicator--Color:var(--pf-c-table__sort__button--active__sort-indicator--Color);--pf-c-table__sort__button__text--Color:var(--pf-c-table__sort__button--active__text--Color)}button:focus{--pf-c-table__sort-indicator--Color:var(--pf-c-table__sort__button--focus__sort-indicator--Color);--pf-c-table__sort__button__text--Color:var(--pf-c-table__sort__button--focus__text--Color)}button.sortable{--pf-c-table--cell--PaddingTop:var(--pf-c-table__sort__button--PaddingTop);--pf-c-table--cell--PaddingRight:var(--pf-c-table__sort__button--PaddingRight);--pf-c-table--cell--PaddingBottom:var(--pf-c-table__sort__button--PaddingBottom);--pf-c-table--cell--PaddingLeft:var(--pf-c-table__sort__button--PaddingLeft);display:flex;width:auto;margin-top:var(--pf-c-table__sort__button--MarginTop);margin-bottom:var(--pf-c-table__sort__button--MarginBottom);margin-left:var(--pf-c-table__sort__button--MarginLeft)}button.selected{--pf-c-table__sort-indicator--Color:var(--pf-c-table__sort--m-selected__sort-indicator--Color);--pf-c-table__sort__button__text--Color:var(--pf-c-table__sort--m-selected__button__text--Color);color:var(--pf-c-table__sort--m-selected__button--Color)}#sort-indicator{width:0;margin-inline-start:-1em;overflow:visible;color:var(--pf-c-table__sort-indicator--Color)}.visually-hidden{position:fixed;top:0;left:0;overflow:hidden;clip:rect(0,0,0,0);white-space:nowrap;border:0}`,vs=If;var Nf={asc:"desc",desc:"asc"},nr=class extends Event{constructor(t,o){super("request-sort",{bubbles:!0,cancelable:!0});this.key=t;this.direction=o}},Uf=new Map(Object.entries({asc:"M88 166.059V468c0 6.627 5.373 12 12 12h56c6.627 0 12-5.373 12-12V166.059h46.059c21.382 0 32.09-25.851 16.971-40.971l-86.059-86.059c-9.373-9.373-24.569-9.373-33.941 0l-86.059 86.059c-15.119 15.119-4.411 40.971 16.971 40.971H88z",desc:"M168 345.941V44c0-6.627-5.373-12-12-12h-56c-6.627 0-12 5.373-12 12v301.941H41.941c-21.382 0-32.09 25.851-16.971 40.971l86.059 86.059c9.373 9.373 24.569 9.373 33.941 0l86.059-86.059c15.119-15.119 4.411-40.971-16.971-40.971H168z",sort:"M214.059 377.941H168V134.059h46.059c21.382 0 32.09-25.851 16.971-40.971L144.971 7.029c-9.373-9.373-24.568-9.373-33.941 0L24.971 93.088c-15.119 15.119-4.411 40.971 16.971 40.971H88v243.882H41.941c-21.382 0-32.09 25.851-16.971 40.971l86.059 86.059c9.373 9.373 24.568 9.373 33.941 0l86.059-86.059c15.12-15.119 4.412-40.971-16.97-40.971z"})),Wa,_s,dt=class extends Of{constructor(){super(...arguments);n(this,Wa);this.sortable=!1;this.selected=!1}connectedCallback(){super.connectedCallback();let t=this.closest("pf-thead"),o=this.closest("pf-table"),s=!!t&&!!o?.contains(t)?"colheader":"rowheader";this.setAttribute("role",s)}render(){let t=!!this.selected;return this.sortable?us`
        <button id="sort-button"
          ...
          <span id="sort-indicator">
            <svg fill="currentColor" height="1em" width="1em" viewBox="0 0 256 512" aria-hidden="true" role="img" style="vertical-align: -0.125em;">${Af`
              <path d="${Uf.get(this.sortDirection??"sort")}"></path>`}
            </svg>
          </span>
        </button>
      `:us`
        <slot></slot>
      `}sort(){let t=Nf[this.sortDirection??"asc"];this.dispatchEvent(new nr(this.key,t))}};Wa=new WeakSet,_s=function(){this.sortable&&this.sort()},dt.styles=[vs],r([za({type:Boolean,reflect:!0})],dt.prototype,"sortable",2),r([za({type:Boolean,reflect:!0})],dt.prototype,"selected",2),r([za({reflect:!0,attribute:"sort-direction"})],dt.prototype,"sortDirection",2),r([za()],dt.prototype,"key",2),dt=r([Df("pf-th")],dt);import{LitElement as Vf,html as sr}from"lit";import{customElement as Yf}from"lit/decorators/custom-element.js";import{property as ys}from"lit/decorators/property.js";import{css as qf}from"lit";var Gf=qf`:host{display:grid;align-items:center;padding-inline-start:calc(50px * var(--_pf-table--expandable-rows,0))}::slotted(*){height:100%}@media (min-width:768px){:host{grid-template-columns:repeat(var(--_pf-table--number-of-columns),1fr)}}#container{display:contents}#expansion,:host([expandable]){position:relative}#expansion{display:block;margin-inline-start:calc(-1 * 50px * var(--_pf-table--expandable-rows,0));grid-auto-flow:row;grid-template-columns:auto;padding:0 1.5rem;display:grid;grid-column:1/-1}:host(:not([expanded])),:host([expanded]) #expansion{border-block-end:1px solid #d2d2d2}:host([expanded]) #expansion::before{content:'';position:absolute;inset:0;border-block-start:1px solid #d2d2d2;inset-block-start:-1px}#expansion::slotted(pf-td){padding-block-start:0;padding-inline-start:0}:host([expandable][expanded])::before{position:absolute;inset-block-start:-1px;inset-inline-end:0;inset-block-end:-1px;inset-inline-start:0;content:"";border-inline-start:3px solid #06c;pointer-events:none;z-index:1}#expansion::slotted(pf-table){margin-block-end:-1px}#toggle-cell{z-index:2;position:absolute;inset-inline-start:0;inset-block-start:1.5rem;padding:0}#toggle-icon{transition:.2s ease-in 0s;vertical-align:-.125em}:host([expanded]) #toggle-icon{transform:rotate(90deg)}`,xs=Gf;import{ifDefined as Xf}from"lit/directives/if-defined.js";xt();var re=class extends Event{constructor(t,o){super("request-expand",{bubbles:!0,cancelable:!0});this.compoundExpanded=!1;o&&(this.compoundExpanded=t??!1,this.row=o)}};function Kf(...i){let e=new Set(i);return{fromAttribute(t){return t&&e.has(t.toLowerCase())?t:t!=null},toAttribute(t){return t?t==="compound"?t:"":null}}}var Zf={fromAttribute(i){return i||i!==null},toAttribute(i){return i?typeof i=="string"?i:"":null}},La,Cs,cr,pi,Ma,Bs,It=class extends Vf{constructor(){super(...arguments);n(this,La);n(this,cr);n(this,Ma);this.expandable=!1;this.expanded=!1}connectedCallback(){super.connectedCallback(),c(this,cr,pi).call(this)}willUpdate(t){t.has("expandable")&&c(this,cr,pi).call(this),t.has("expanded")&&c(this,La,Cs).call(this)}render(){return[this.expandable&&this.expandable!=="compound"&&sr`
    ...
    `}};import{css as Zm}from"lit";var Qm=Zm`:host{position:relative;display:inline-grid;padding:var(--pf-c-tile--PaddingTop,var(--pf-global--spacer--lg,1.5rem)) var(--pf-c-tile--PaddingRight,var(--pf-global--spacer--lg,1.5rem)) var(--pf-c-tile--PaddingBottom,var(--pf-global--spacer--lg,1.5rem)) var(--pf-c-tile--PaddingLeft,var(--pf-global--spacer--lg,1.5rem));text-align:center;cursor:pointer;background-color:var(--pf-c-tile--BackgroundColor,var(--pf-global--BackgroundColor--100,var(--pf-global--BackgroundColor--light-100),#fff));grid-template-rows:-webkit-min-content;grid-template-rows:min-content;transition:var(--pf-c-tile--Transition, none);transform:translateY(var(--pf-c-tile--TranslateY,0))}:host::after,:host::before{position:absolute;pointer-events:none;content:""}:host::before{top:0;right:0;bottom:0;left:0;border:var(--pf-c-tile--before--BorderWidth,var(--pf-global--BorderWidth--sm,1px)) solid var(--pf-c-tile--before--BorderColor,var(--pf-global--BorderColor--100,#d2d2d2))}:host::after{right:0;bottom:0;left:0;height:var(--pf-c-tile--after--Height,var(--pf-global--BorderWidth--lg,3px));background-color:var(--pf-c-tile--after--BackgroundColor,transparent);transition:var(--pf-c-tile--after--Transition, none);transform:scaleY(var(--pf-c-tile--after--ScaleY,1)) translateY(var(--pf-c-tile--after--TranslateY,0))}:host(:hover){--pf-c-tile__title--Color:var(--pf-c-tile--hover__title--Color, var(--pf-global--primary-color--100, #06c));--pf-c-tile__icon--Color:var(--pf-c-tile--hover__icon--Color, var(--pf-global--primary-color--100, #06c));--pf-c-tile--after--BackgroundColor:var(--pf-c-tile--hover--after--BackgroundColor, var(--pf-global--active-color--400, #73bcf7))}:host(:focus){--pf-c-tile__title--Color:var(--pf-c-tile--focus__title--Color, var(--pf-global--primary-color--100, #06c));--pf-c-tile__icon--Color:var(--pf-c-tile--focus__icon--Color, var(--pf-global--primary-color--100, #06c));--pf-c-tile--after--BackgroundColor:var(--pf-c-tile--focus--after--BackgroundColor, var(--pf-global--active-color--400, #73bcf7))}:host(:active),:host([selected]){--pf-c-tile__title--Color:var(--pf-c-tile--m-selected__title--Color, var(--pf-global--primary-color--100, #06c));--pf-c-tile__icon--Color:var(--pf-c-tile--m-selected__icon--Color, var(--pf-global--primary-color--100, #06c));--pf-c-tile--TranslateY:var(--pf-c-tile--m-selected--TranslateY,
                          ...
                          var(--pf-global--Transition, all 250ms cubic-bezier(0.42, 0, 0.58, 1)));--pf-c-tile--after--ScaleY:var(--pf-c-tile--m-selected--after--ScaleY, 2)}:host([disabled]){--pf-c-tile--BackgroundColor:var(--pf-c-tile--m-disabled--BackgroundColor, var( --pf-global--disabled-color--300, #f0f0f0));--pf-c-tile__title--Color:var(--pf-c-tile--m-disabled__title--Color, var(--pf-global--disabled-color--100, #6a6e73));--pf-c-tile__body--Color:var(--pf-c-tile--m-disabled__body--Color,  var(--pf-global--disabled-color--100, #6a6e73));--pf-c-tile--before--BorderWidth:0;--pf-c-tile__icon--Color:var(--pf-c-tile--m-disabled__icon--Color, var(--pf-global--disabled-color--100, #6a6e73));pointer-events:none}[part=header]{display:flex;align-items:center;justify-content:center}[part=title]{color:var(--pf-c-tile__title--Color,var(--pf-global--Color--100,var(--pf-global--Color--dark-100,#151515)))}[part=body]{font-size:var(--pf-c-tile__body--FontSize, var(--pf-global--FontSize--xs, .75rem));color:var(--pf-c-tile__body--Color,var(--pf-global--Color--100,#151515))}[part=icon]{--_icon-size:var(--pf-c-tile__icon--FontSize: var(--pf-global--icon--FontSize--md, 1.125rem));--pf-icon--size:var(--_icon-size);margin-right:var(--pf-c-tile__icon--MarginRight,var(--pf-global--spacer--sm,.5rem));font-size:var(--_icon-size);color:var(--pf-c-tile__icon--Color,var(--pf-global--Color--100,#151515))}:host([stacked]) [part=header]{--pf-c-tile__icon--MarginRight:0;--_icon-size:var(--pf-c-tile__icon--FontSize, var(--pf-c-tile__header--m-stacked__icon--FontSize, var(--pf-global--icon--FontSize--lg, 1.5rem)));flex-direction:column;justify-content:initial}:host([stacked=lg]) [part=icon]{--_icon-size:var(--pf-c-tile__icon--FontSize, var(--pf-c-tile--m-display-lg__header--m-stacked__icon--FontSize, var(--pf-global--icon--FontSize--xl, 3.375rem)))}:host([stacked]) [part=icon]{display:flex;align-items:center;justify-content:center;margin-bottom:var(--pf-c-tile__header--m-stacked__icon--MarginBottom,var(--pf-global--spacer--xs,.25rem))}#body::slotted(:is(h1,h2,h3,h4,h5,h6,p)),#title::slotted(:is(h1,h2,h3,h4,h5,h6,p)){margin-block:0}`,sc=Qm;var We=class extends tl{constructor(){super(...arguments);this.selected=!1}};We.styles=[sc],r([cc({reflect:!0,type:Boolean})],We.prototype,"selected",2),r([cc({reflect:!0})],We.prototype,"stacked",2),We=r([Jm("pf-tile")],We);import{LitElement as rg,html as ag}from"lit";import{customElement as lg}from"lit/decorators/custom-element.js";import{property as Nt}from"lit/decorators/property.js";import{__classPrivateFieldGet as k,__classPrivateFieldSet as pc}from"tslib";var xi,dc,fc,le,I,el,mc,tg={dateFormat:void 0,timeFormat:void 0,customFormat:void 0,displaySuffix:"",locale:void 0,relative:!1,utc:!1,hour12:!1},ie=class{get localeString(){return k(this,le,"f").toLocaleString(k(this,I,"f").locale)}get date(){return k(this,le,"f")}set date(e){pc(this,le,new Date(e),"f")}get isoString(){return k(this,le,"f").toISOString()}get time(){if(k(this,I,"f").relative)return k(this,xi,"m",mc).call(this);{let{displaySuffix:e,locale:t}=k(this,I,"f");return k(this,I,"f").utc&&(e||(e="UTC")),`${k(this,le,"f").toLocaleString(t,k(this,I,"f").customFormat??{hour12:k(this,I,"f").hour12,timeStyle:k(this,I,"f").timeFormat,dateStyle:k(this,I,"f").dateFormat,...k(this,I,"f").utc&&{timeZone:"UTC"}})} ${e??""}`.trim()}}constructor(e,t){xi.add(this),le.set(this,new Date),I.set(this,{}),el.set(this,void 0),pc(this,el,e,"f"),e.addController(this);for(let[o,l]of Object.entries(k(this,I,"f")))k(this,I,"f")[o]=t?.[o]??l}set(e,t){k(ie,dc,"m",fc).call(ie,e)&&(k(this,I,"f")[e]=t,k(this,el,"f").requestUpdate())}};dc=ie,le=new WeakMap,I=new WeakMap,el=new WeakMap,xi=new WeakSet,fc=function(e){return e in tg},mc=function(){let e=k(this,le,"f"),{locale:t}=k(this,I,"f"),o=new Intl.RelativeTimeFormat(t,{localeMatcher:"best fit",numeric:"auto",style:"long"}),l=e.getTime()-Date.now(),s=l>0?1:-1,p=0,d,h=Math.round(Math.abs(l)/1e3),S=Math.round(h/60),O=Math.round(S/60),Z=Math.round(O/24),io=Math.round(Z/30),ol=Math.round(io/12);return io>=12?(p=ol,d="year"):Z>=30?(p=io,d="month"):O>=24?(p=Z,d="day"):S>=45?(p=O,d="hour"):h>=45?(p=S,d="minute"):h>=10&&(p=h,d="second"),typeof d<"u"?o.format(s*p,d):"just now"};import{css as eg}from"lit";var og=eg`:host{display:inline}time{text-decoration:var(--_timestamp-text-decoration,none);text-underline-offset:var(--_timestamp-text-underline-offset,initial)}`,gc=og;var ig={fromAttribute(i){return!i||i==="true"}},gt,U=class extends rg{constructor(){super(...arguments);n(this,gt,new ie(this))}get date(){return a(this,gt).localeString}set date(t){a(this,gt).date=new Date(t)}get isoString(){return a(this,gt).isoString}get time(){return a(this,gt).time}connectedCallback(){super.connectedCallback(),this.hasAttribute("date")&&(a(this,gt).date=new Date(this.getAttribute("date")))}willUpdate(t){for(let[o]of t)a(this,gt).set(o,this[o])}render(){return ag`
      <time datetime="${a(this,gt).isoString}">${a(this,gt).time}</time>
    `}};gt=new WeakMap,U.styles=[gc],r([Nt({reflect:!0,attribute:"date-format"})],U.prototype,"dateFormat",2),r([Nt({reflect:!0,attribute:"time-format"})],U.prototype,"timeFormat",2),r([Nt({attribute:!1})],U.prototype,"customFormat",2),r([Nt({reflect:!0,attribute:"display-suffix"})],U.prototype,"displaySuffix",2),r([Nt({reflect:!0})],U.prototype,"locale",2),r([Nt({reflect:!0,type:Boolean})],U.prototype,"relative",2),r([Nt({reflect:!0,type:Boolean})],U.prototype,"utc",2),r([Nt({reflect:!0,attribute:"hour-12",converter:ig})],U.prototype,"hour12",2),r([Nt({reflect:!0})],U.prototype,"date",1),U=r([lg("pf-timestamp")],U);oa();export{Yl as ModalCancelEvent,Xl as ModalCloseEvent,Kl as ModalOpenEvent,Tt as PfAccordion,Zt as PfAccordionHeader,Pe as PfAccordionPanel,fe as PfAvatar,Qt as PfBadge,Jt as PfBanner,rt as PfButton,ir as PfCaption,Rt as PfCard,w as PfClipboardCopy,Ye as PfCodeBlock,Kt as PfIcon,st as PfJumpLinks,ee as PfJumpLinksItem,Po as PfJumpLinksList,G as PfLabel,y as PfModal,ye as PfPanel,m as PfPopover,Y as PfProgress,ct as PfProgressStep,Ct as PfProgressStepper,zo as PfSpinner,lr as PfSwitch,jt as PfTab,Be as PfTabPanel,At as PfTable,Bt as PfTabs,dr as PfTbody,Ot as PfTd,W as PfTextInput,dt as PfTh,pr as PfThead,We as PfTile,U as PfTimestamp,q as PfTooltip,It as PfTr,Jl as PopoverHiddenEvent,Ql as PopoverHideEvent,ti as PopoverShowEvent,ei as PopoverShownEvent,re as RequestExpandEvent,nr as RequestSortEvent};
